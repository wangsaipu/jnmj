...
class Taskprogress extends CmsController
{
    public function index()
    {
        ...
        $res = db('bookkeep')->alias('a')->field('a.*')->order('a.id desc')->paginate($searchSize, false, $post_val);
        //dump($res);exit;
        ...
        $arr = [ '客户名称', '产品名称', '负责人', '负责人部门', '协作人', '协作人部门', '任务进度', '任务状态',
            '当前进度', '完成时间', '服务金额', '支出预算', '回款进度', '末次收款时间','累计实收','累计支出','累计有效收入',
            '当期实收','当期支出','当期有效收入','销售代表','销售代表部门','本单来源分类','本单来源详情','本单来源 来源人部门',
            '本单来源 渠道负责人','本单来源负责人部门','本单来源 渠道类型','服务公司','创建时间','首单创建时间'];
        $init_index = 2;
        if ($init_index == 2) {
        ...
        $this->assign('hidden_index', [22,23,24,25,26,27,28,29,30]);
