...
class Satisfaction extends CmsController
{
    public function index()
    {
        ...
        $res = db('satisfaction')->alias('a')->field('a.*')->order('a.id desc')->paginate($searchSize, false, $post_val);
        //dump($res);exit;
        ...
        $arr = [ '评价人', '客户公司', '办理业务', '评分', '有无额外收费', '意见和建议', '业务人员',
            '业务部门','服务人员','服务部门','评价时间'];
        $init_index = 2;
        if ($init_index == 2) {
