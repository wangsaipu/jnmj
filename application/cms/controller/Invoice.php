...
class Invoice extends CmsController
{
    public function index()
    {
        ...
        $res = db('invoice')->alias('a')->field('a.*')->order('a.id desc')->paginate($searchSize, false, $post_val);
        ...
        $arr = ['开票编号', '客户名称', '合同流水号','发票类型', '开票金额', '开票状态', '审批状态', '发票抬头', '服务公司', '申请人','申请时间', '开票人','开票时间','社会信用代码'];
        $init_index = 2;
        if ($init_index == 2) {
