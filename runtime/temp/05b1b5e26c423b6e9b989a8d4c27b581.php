<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:90:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/statistics/index.html";i:1541236779;s:87:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/header.html";i:1537169502;s:84:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/top.html";i:1537169502;s:85:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/left.html";i:1537169502;s:98:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/table/show_column.html";i:1537169502;s:96:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/table/page_size.html";i:1537169502;s:87:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/footer.html";i:1541236462;s:99:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/public_js/js_table.html";i:1537169502;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="row-fluid inbox">
                <div class="tabbable tabbable-custom tabbable-full-width">
                    <ul class="nav nav-tabs">
                        <li  class="active"><a href="<?php echo url('statistics/index'); ?>">总数据</a>
                        <!--<li><a href="<?php echo url('statistics/bucket'); ?>">时间段</a>
                        <li><a href="<?php echo url('statistics/day'); ?>">天数据</a>
                        <li><a href="<?php echo url('statistics/mouth'); ?>">月数据</a>-->
                    </ul>
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body no-more-tables" style='overflow:auto'>
								...
								<label>
									<select class="m-wrap small searchSize" name="searchSize" aria-controls="sample_1">
										<option  value="10" <?php if($searchSize=='100'): ?> selected <?php endif; ?>>100</option>
                            ...
                            <form action="<?php echo url('index'); ?>" id='searchForm' method='post' class="span5">
                                ...
                                <div class="input-append">
                                    <input type="text" name="time1"   class="m-wrap m-ctrl-medium date-picker" data-date-format="yyyy-mm-dd" readOnly="true" size="16"  value="<?php echo (isset($start) && ($start !== '')?$start:''); ?>">
                                    <input type="text" name="time2"   class="m-wrap m-ctrl-medium date-picker" data-date-format="yyyy-mm-dd" readOnly="true" size="16"  value="<?php echo (isset($end) && ($end !== '')?$end:''); ?>">
                            ...
                            <table class="table table-striped table-bordered table-hover table-full-width  table-condensed cf" id="sample_1">
                                <thead class='cf'>
                                    <tr>
                                        <?php foreach($my_rule['showlist'] as $k=>$v): if(isset($hidden_index)): ?>
                                        <th  class="numeric <?php if(in_array($k,$hidden_index)): ?> inithidden <?php endif; ?>"><nobr><?php echo $v; ?>&nbsp;&nbsp;&nbsp;</nobr></th>
                                        <?php else: ?>
                                ...
                                <?php foreach($bucket as $k=>$info): ?>
                                <tr data-id=''>

                                    <td data-title="序号" class="numeric" ><nobr><?php echo $info[24]; ?></nobr></td>
                                    <td data-title="0" class="numeric"><nobr><?php echo (isset($info[0]) && ($info[0] !== '')?$info[0]:'0'); ?></nobr></td>
                                    <td data-title="1" class="numeric"><nobr><?php echo (isset($info[1]) && ($info[1] !== '')?$info[1]:'0'); ?></nobr></td>
                                    <td data-title="2" class="numeric"><nobr><?php echo (isset($info[2]) && ($info[2] !== '')?$info[2]:'0'); ?></nobr></td>
                                    <td data-title="3" class="numeric"><nobr><?php echo (isset($info[3]) && ($info[3] !== '')?$info[3]:'0'); ?></nobr></td>
                                    <td data-title="4" class="numeric"><nobr><?php echo (isset($info[4]) && ($info[4] !== '')?$info[4]:'0'); ?></nobr></td>
                                    <td data-title="5" class="numeric"><nobr><?php echo (isset($info[5]) && ($info[5] !== '')?$info[5]:'0'); ?></nobr></td>
                                    <td data-title="6" class="numeric"><nobr><?php echo (isset($info[6]) && ($info[6] !== '')?$info[6]:'0'); ?></nobr></td>
                                    <td data-title="7" class="numeric"><nobr><?php echo (isset($info[7]) && ($info[7] !== '')?$info[7]:'0'); ?></nobr></td>
                                    <td data-title="8" class="numeric"><nobr><?php echo (isset($info[8]) && ($info[8] !== '')?$info[8]:'0'); ?></nobr></td>
                                    <td data-title="9" class="numeric"><nobr><?php echo (isset($info[9]) && ($info[9] !== '')?$info[9]:'0'); ?></nobr></td>
                                    <td data-title="10" class="numeric"><nobr><?php echo (isset($info[10]) && ($info[10] !== '')?$info[10]:'0'); ?></nobr></td>
                                    <td data-title="11" class="numeric"><nobr><?php echo (isset($info[11]) && ($info[11] !== '')?$info[11]:'0'); ?></nobr></td>
                                    <td data-title="12" class="numeric"><nobr><?php echo (isset($info[12]) && ($info[12] !== '')?$info[12]:'0'); ?></nobr></td>
                                    <td data-title="13" class="numeric"><nobr><?php echo (isset($info[13]) && ($info[13] !== '')?$info[13]:'0'); ?></nobr></td>
                                    <td data-title="14" class="numeric"><nobr><?php echo (isset($info[14]) && ($info[14] !== '')?$info[14]:'0'); ?></nobr></td>
                                    <td data-title="15" class="numeric"><nobr><?php echo (isset($info[15]) && ($info[15] !== '')?$info[15]:'0'); ?></nobr></td>
                                    <td data-title="16" class="numeric"><nobr><?php echo (isset($info[16]) && ($info[16] !== '')?$info[16]:'0'); ?></nobr></td>
                                    <td data-title="17" class="numeric"><nobr><?php echo (isset($info[17]) && ($info[17] !== '')?$info[17]:'0'); ?></nobr></td>
                                    <td data-title="18" class="numeric"><nobr><?php echo (isset($info[18]) && ($info[18] !== '')?$info[18]:'0'); ?></nobr></td>
                                    <td data-title="19" class="numeric"><nobr><?php echo (isset($info[19]) && ($info[19] !== '')?$info[19]:'0'); ?></nobr></td>
                                    <td data-title="20" class="numeric"><nobr><?php echo (isset($info[20]) && ($info[20] !== '')?$info[20]:'0'); ?></nobr></td>
                                    <td data-title="21" class="numeric"><nobr><?php echo (isset($info[21]) && ($info[21] !== '')?$info[21]:'0'); ?></nobr></td>
                                    <td data-title="22" class="numeric"><nobr><?php echo (isset($info[22]) && ($info[22] !== '')?$info[22]:'0'); ?></nobr></td>
                                    <td data-title="23" class="numeric"><nobr><?php echo (isset($info[23]) && ($info[23] !== '')?$info[23]:'0'); ?></nobr></td>
                                    <td data-title="24" class="numeric"><nobr><?php echo (isset($info[25]) && ($info[25] !== '')?$info[25]:'0'); ?></nobr></td>
                                </tr>
                                <?php endforeach; ?>
                        ...
                        <script type="text/javascript" src="<?php echo \think\Config::get('cms_resource'); ?>/js/amcharts.js"></script>
                        <div id="chartdiv" style="margin: -.8em auto; text-align:center;  height: 390px ;background-color: #fff;"></div>
