                    ...
                    <div class="portlet-body no-more-tables" style='overflow:auto'>
                        ...
                        <table class="table table-striped table-bordered table-hover table-full-width  table-condensed cf" id="sample_1">
                            ...
                            <tr data-id='<?php echo $info['id']; ?>'>
                                ...
                                <td data-title="手机号码" class="numeric" style="width:10%;"><span style="padding:1% 60% 2% 1%" class="hideen"><?php echo (isset($info['phonenum']) && ($info['phonenum'] !== '')?$info['phonenum']:''); ?></span><span class="show" style="display: none;"><?php echo (isset($info['phone']) && ($info['phone'] !== '')?$info['phone']:''); ?></span></td>
