                    ...
                    <div class="portlet-body no-more-tables" style='overflow:auto'>
                        ...
                        <table class="table table-striped table-bordered table-hover table-full-width  table-condensed cf" id="sample_1">
                            ...
                            <tr data-id='<?php echo $info['id']; ?>'>
                                ...
                                <td data-title="客户姓名" class="numeric"><?php echo (isset($info['username']) && ($info['username'] !== '')?$info['username']:''); ?></td>
                                <td data-title="手机号码" class="numeric"><?php echo (isset($info['phonenum']) && ($info['phonenum'] !== '')?$info['phonenum']:''); ?></td>
                                <td data-title="ip地址" class="numeric"><?php echo (isset($info['ip']) && ($info['ip'] !== '')?$info['ip']:''); ?></td>
                                <td data-title="归属地" class="numeric"><?php echo (isset($info['place']) && ($info['place'] !== '')?$info['place']:''); ?></td>
                                <td data-title="来路渠道" class="numeric"><?php echo (isset($info['road']) && ($info['road'] !== '')?$info['road']:''); ?></td>
                                <td data-title="关键词" class="numeric inithidden"><?php echo (isset($info['keyword']) && ($info['keyword'] !== '')?$info['keyword']:''); ?></td>
                                <td data-title="来路URL" class="numeric"><?php echo (isset($info['keyword']) && ($info['keyword'] !== '')?$info['keyword']:''); ?></td>
