<?php if (!defined('THINK_PATH')) exit(); /*a:10:{s:86:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/worker/index.html";i:1537434490;s:87:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/header.html";i:1537169502;s:84:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/top.html";i:1537169503;s:85:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/left.html";i:1537169502;s:98:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/table/show_column.html";i:1537169503;s:96:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/table/page_size.html";i:1537169503;s:92:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/table/thead.html";i:1537169503;s:85:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/page.html";i:1537169502;s:87:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/footer.html";i:1537348305;s:99:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/public_js/js_table.html";i:1537169502;}*/ ?>
<!DOCTYPE html>
	...
	if($('li').hasClass('<?php echo $controller__action; ?>')){
		...
		<div class="page-content">
			<div class="container-fluid">
				...
				<a style="margin-bottom: 5px;" class="btn blue" href="<?php echo url('add'); ?>"><i class="icon-plus"></i> 添加职员信息</a>
					...
					<div class="portlet box green">
						...
						<form action="<?php echo url('index'); ?>" id='searchForm' method='post' class="span3">
							...
							<input type="hidden" value='<?php echo (isset($cms_user_type_id) && ($cms_user_type_id !== '')?$cms_user_type_id:''); ?>' name="cms_user_type_id" id='typeid1'>
							<input type="text" name="name"  class='m-wrap span8' placeholder="职员名字" value='<?php echo (isset($name) && ($name !== '')?$name:''); ?>'>
						...
						<select  class="span2 chosen" data-with-diselect="1" name="cms_user_type_id" data-placeholder="部门类型" tabindex="1">
							<option value=""></option>
	                        <?php echo new_getfkarr('bmlx','branch',$arr,[]); foreach($arr as $k=>$fk): if(isset($cms_user_type_id)): ?>
	                        <option value="<?php echo $fk['id']; ?>" <?php if($cms_user_type_id==$fk['id']): ?> selected <?php endif; ?>><?php echo $fk['bmlx']; ?></option>
	                            <?php else: ?>
							...
							<table class="table table-striped table-bordered table-hover table-full-width table-condensed  cf"  id="sample_1" >
								...
								<tbody>
									...
									<tr data-id='<?php echo $info['id']; ?>' >
										...
										<td data-column="2" data-title="姓名" class="numeric"><nobr><?php echo (isset($info['name']) && ($info['name'] !== '')?$info['name']:''); ?></nobr></td>
										<td data-column="3" data-title="账号" class="numeric"><nobr><?php echo (isset($info['username']) && ($info['username'] !== '')?$info['username']:''); ?></nobr></td>

										<td data-column="5" data-title="性别" class="numeric"><nobr><?php echo showstatus($info['sex'],'女,男:0,1'); ?></nobr></td>
										<td data-column="6" data-title="职位类型" class="numeric"><nobr><?php echo (isset($info['bmlx']) && ($info['bmlx'] !== '')?$info['bmlx']:''); ?></nobr></td>

										<td data-column="9" data-title="电话号码" class="numeric"><nobr><?php echo (isset($info['phone']) && ($info['phone'] !== '')?$info['phone']:''); ?></nobr></td>
										<td data-column="10" data-title="头像" class="numeric"><nobr><img src="<?php echo $info['image']; ?>" alt="image" style="width:35px;height:35px;border-radius:50px;"/></nobr></td>
										<td data-column="11" data-title="备注" class="numeric"><nobr><?php echo (isset($info['note']) && ($info['note'] !== '')?$info['note']:''); ?></nobr></td>
										<td data-column="12" data-title="操作" class="numeric">
											<nobr>
												<a href="<?php echo url('update',array('id'=>$info['id'])); ?>" class='btn mini blue' style='padding:4px 10px;'  target="_black"><i class="icon-pencil"></i> 修改</a>
												<a href="javascript:if(confirm('确实要重置密码吗?'))location='<?php echo url('reset_pwd',array('id'=>$info['id'])); ?>'" class='btn mini red' style='padding:4px 10px;'  target="_black"><i class="icon-pencil"></i> 重置密码</a>
											</nobr>
										</td>
									</tr>
									<?php endforeach; ?>
