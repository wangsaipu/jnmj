	...
	<div class="page-content">
		<div class="container-fluid">
			...
			<div class="row-fluid inbox">
				<a style="margin-bottom: 5px;" class="btn blue"  href="<?php echo url('add'); ?>"><i class="icon-plus"></i> 添加栏目设置信息</a>
					...
					<div class="portlet-body no-more-tables" style='overflow:auto'>
						...
						<table class="table table-striped table-bordered table-hover table-full-width table-condensed  cf"  id="sample_1" >
							...
							<tr data-id='<?php echo $info['id']; ?>' >
								...
								<td data-title="项目名称" class="numeric"><nobr><?php echo (isset($info['lname']) && ($info['lname'] !== '')?$info['lname']:''); ?></nobr></td>
								<td data-title="PC网址" class="numeric"><nobr><?php echo (isset($info['pcurl']) && ($info['pcurl'] !== '')?$info['pcurl']:''); ?></nobr></td>
                                <td data-title="移动端网址" class="numeric"><nobr><?php echo (isset($info['murl']) && ($info['murl'] !== '')?$info['murl']:''); ?></nobr></td>
								<td data-title="操作" class="numeric">
									<nobr>
										<a href="<?php echo url('update',array('id'=>$info['id'])); ?>" class='btn mini blue' style='padding:4px 10px;'><i class="icon-pencil"></i> 修改</a>
									</nobr>
								</td>
							</tr>
							<?php endforeach; ?>
