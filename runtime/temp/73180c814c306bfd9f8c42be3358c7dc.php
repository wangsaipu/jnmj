                    ...
                    <div class="portlet-body no-more-tables" style='overflow:auto'>
                        ...
                        <table class="table table-striped table-bordered table-hover table-full-width  table-condensed cf" id="sample_1">
                            ...
                            <tr data-id='<?php echo $info['id']; ?>'>
                                ...
                                <td data-title="完成情况" class="numeric"><?php echo (isset($info['pid']) && ($info['pid'] !== '')?$info['pid']:''); ?></td>
                                <td data-title="责任人" class="numeric"><?php echo (isset($info['responsibe']) && ($info['responsibe'] !== '')?$info['responsibe']:''); ?></td>
                                <td data-title="责任部门" class="numeric"><?php echo (isset($info['res_dep']) && ($info['res_dep'] !== '')?$info['res_dep']:''); ?></td>
                                <td data-title="服务公司" class="numeric"><?php echo (isset($info['service_company']) && ($info['service_company'] !== '')?$info['service_company']:''); ?></td>
                                <td data-title="开始月份" class="numeric"><?php echo (isset($info['start_month']) && ($info['start_month'] !== '')?$info['start_month']:''); ?></td>
                                <td data-title="合同到期月" class="numeric"><?php echo (isset($info['contract_to']) && ($info['contract_to'] !== '')?$info['contract_to']:''); ?></td>
                                <td data-title="服务到月份" class="numeric"><?php echo (isset($info['service_to']) && ($info['service_to'] !== '')?$info['service_to']:''); ?></td>
                                <td data-title="费用到期月份" class="numeric"><?php echo (isset($info['pay_to_month']) && ($info['pay_to_month'] !== '')?$info['pay_to_month']:''); ?></td>
                                <td data-title="可服务月数" class="numeric"><?php echo (isset($info['service_month']) && ($info['service_month'] !== '')?$info['service_month']:''); ?></td>
                                <td data-title="月费用" class="numeric"><?php echo (isset($info['month_price']) && ($info['month_price'] !== '')?$info['month_price']:''); ?></td>
                                <td data-title="总收款" class="numeric"><?php echo (isset($info['total_price']) && ($info['total_price'] !== '')?$info['total_price']:''); ?></td>
                                <td data-title="总消耗" class="numeric"><?php echo (isset($info['total_cosume']) && ($info['total_cosume'] !== '')?$info['total_cosume']:''); ?></td>
                                <td data-title="余额" class="numeric"><?php echo (isset($info['balance']) && ($info['balance'] !== '')?$info['balance']:''); ?></td>
                                <td data-title="待收" class="numeric"><?php echo (isset($info['daishou']) && ($info['daishou'] !== '')?$info['daishou']:''); ?></td>
                                <td data-title="服务金额" class="numeric"><?php echo (isset($info['service_money']) && ($info['service_money'] !== '')?$info['service_money']:''); ?></td>
                                <td data-title="工作倍数" class="numeric"><?php echo (isset($info['work_times']) && ($info['work_times'] !== '')?$info['work_times']:''); ?></td>
