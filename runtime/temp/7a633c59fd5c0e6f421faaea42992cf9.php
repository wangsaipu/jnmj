                    ...
                    <div class="portlet-body no-more-tables" style='overflow:auto'>
                        ...
                        <table class="table table-striped table-bordered table-hover table-full-width  table-condensed cf" id="sample_1">
                            ...
                            <tr data-id='<?php echo $info['id']; ?>'>
                                ...
                                <td data-title="产品id" class="numeric"><?php echo (isset($info['p_id']) && ($info['p_id'] !== '')?$info['p_id']:''); ?></td>
                                <td data-title="产品名称" class="numeric"><?php echo (isset($info['p_name']) && ($info['p_name'] !== '')?$info['p_name']:''); ?></td>
                                <td data-title="产品板块" class="numeric"><?php echo (isset($info['service_type']) && ($info['service_type'] !== '')?$info['service_type']:''); ?></td>
                                <td data-title="产品大类" class="numeric"><?php echo (isset($info['category']) && ($info['category'] !== '')?$info['category']:''); ?></td>
                                <td data-title="产品状态" class="numeric"><?php echo (isset($info['state']) && ($info['state'] !== '')?$info['state']:''); ?></td>
                                <td data-title="推荐价格" class="numeric"><?php echo (isset($info['min_price']) && ($info['min_price'] !== '')?$info['min_price']:''); ?>&nbsp;~&nbsp;<?php echo (isset($info['max_price']) && ($info['max_price'] !== '')?$info['max_price']:''); ?></td>
                                <td data-title="是否周期产品" class="numeric"><?php echo (isset($info['or_cycle']) && ($info['or_cycle'] !== '')?$info['or_cycle']:''); ?></td>
                                <td data-title="创建时间" class="numeric"><?php echo (isset($info['create_time']) && ($info['create_time'] !== '')?$info['create_time']:''); ?></td>
                                <td data-title="更新时间" class="numeric"><?php echo (isset($info['update_time']) && ($info['update_time'] !== '')?$info['update_time']:''); ?></td>
