					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="<?php echo url('swt/index'); ?>">客户资料</a>
								<i class="icon-angle-right"></i>
							</li>
							...
							<div class="portlet-body form">
								<form action="<?php echo url('update'); ?>" method='post' id="form_sample_2" class="form-horizontal">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="username" data-required="1" class="span6 m-wrap" placeholder="请输入客户姓名" value="<?php echo (isset($info['username']) && ($info['username'] !== '')?$info['username']:''); ?>">
										</div>
									</div>
                                    <div class="control-group">
