								...
								<tbody>
									...
									<tr data-id='<?php echo $info['id']; ?>'>
                                        ...
                                        <td data-title="数据状态" class="numeric"><?php echo (isset($info['state']) && ($info['state'] !== '')?$info['state']:''); ?></td>                                        
                                      	<td data-title="留言" class="numeric"><?php echo (isset($info['leave_word']) && ($info['leave_word'] !== '')?$info['leave_word']:''); ?></td>
                                        <td data-title="备注" class="numeric" style="width: 350px;"><?php echo (isset($info['beizhu']) && ($info['beizhu'] !== '')?$info['beizhu']:''); ?></td>
