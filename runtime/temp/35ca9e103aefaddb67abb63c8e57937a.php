					...
					<div class="span12">
						<div class="portlet box green">
							...
							<div class="portlet-body form">
								<form action="<?php echo url('myImage'); ?>" method='post' id="form_sample_2" class="form-horizontal">
