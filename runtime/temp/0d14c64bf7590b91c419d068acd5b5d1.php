                    ...
                    <div class="portlet-body no-more-tables" style='overflow:auto'>
                        ...
                        <table class="table table-striped table-bordered table-hover table-full-width  table-condensed cf" id="sample_1">
                            ...
                            <tr data-id='<?php echo $info['id']; ?>'>
                                ...
                                <td data-title="服务金额" class="numeric"><?php echo (isset($info['sid']) && ($info['sid'] !== '')?$info['sid']:''); ?></td>
                                <td data-title="违约金" class="numeric"><?php echo (isset($info['damages']) && ($info['damages'] !== '')?$info['damages']:''); ?></td>
                                <td data-title="实收" class="numeric"><?php echo (isset($info['shishou']) && ($info['shishou'] !== '')?$info['shishou']:''); ?></td>
                                <td data-title="消耗" class="numeric"><?php echo (isset($info['consume']) && ($info['consume'] !== '')?$info['consume']:''); ?></td>
                                <td data-title="支出" class="numeric"><?php echo (isset($info['zhichu']) && ($info['zhichu'] !== '')?$info['zhichu']:''); ?></td>
                                <td data-title="退款" class="numeric"><?php echo (isset($info['refund']) && ($info['refund'] !== '')?$info['refund']:''); ?></td>
                                <td data-title="剩余待收" class="numeric"><?php echo (isset($info['collect']) && ($info['collect'] !== '')?$info['collect']:''); ?></td>
