<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:89:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/consumer/update.html";i:1537169503;s:87:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/header.html";i:1537169502;s:84:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/top.html";i:1537169503;s:85:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/left.html";i:1537169502;s:84:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/nav.html";i:1537169502;s:87:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/footer.html";i:1537346055;s:94:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/add/footer_js.html";i:1537169501;s:95:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/public_js/file.html";i:1537169502;}*/ ?>
<!DOCTYPE html>
							...
							<div class="portlet-body form">
								<form action="<?php echo url('update'); ?>" method='post' id="form_sample_2" class="form-horizontal">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="cname" data-required="1" class="span6 m-wrap" placeholder="请输入客户姓名" value="<?php echo (isset($info['cname']) && ($info['cname'] !== '')?$info['cname']:''); ?>">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">手机号<span class="required">*</span></label>
                                        <div class="controls">
                                            <input type="text" name="phonenum" data-required="1" class="span6 m-wrap" placeholder="请输入手机号" value="<?php echo (isset($info['phonenum']) && ($info['phonenum'] !== '')?$info['phonenum']:''); ?>">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">QQ号码<span class="required">*</span></label>
                                        <div class="controls">
                                            <input type="text" name="qq" data-required="1" class="span6 m-wrap" placeholder="请输入QQ号码" value="<?php echo (isset($info['qq']) && ($info['qq'] !== '')?$info['qq']:''); ?>">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">微信号<span class="required">*</span></label>
                                        <div class="controls">
                                            <input type="text" name="wx" data-required="1" class="span6 m-wrap" placeholder="请输入微信号" value="<?php echo (isset($info['wx']) && ($info['wx'] !== '')?$info['wx']:''); ?>">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">职业<span class="required">*</span></label>
                                        <div class="controls">
                                            <input type="text" name="job" data-required="1" class="span6 m-wrap" placeholder="请输入职业" value="<?php echo (isset($info['job']) && ($info['job'] !== '')?$info['job']:''); ?>">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">地区<span class="required">*</span></label>
                                        <div class="controls">
                                            <input type="text" name="place" data-required="1" class="span6 m-wrap" placeholder="请输入地区" value="<?php echo (isset($info['place']) && ($info['place'] !== '')?$info['place']:''); ?>">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">来路<span class="required">*</span></label>
                                        <div class="controls">
                                            <input type="text" name="road" data-required="1" class="span6 m-wrap" placeholder="请输入来路" value="<?php echo (isset($info['road']) && ($info['road'] !== '')?$info['road']:''); ?>">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">客服<span class="required">*</span></label>
                                        <div class="controls">
                                            <input type="text" name="kid" data-required="1" class="span6 m-wrap" placeholder="请输入客服" value="<?php echo (isset($info['kid']) && ($info['kid'] !== '')?$info['kid']:''); ?>">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">数据状态<span class="required">*</span></label>
										<div class="controls">
											<select  class="span2 chosen" data-with-diselect="1" name="state" data-placeholder="<?php echo (isset($info['state']) && ($info['state'] !== '')?$info['state']:''); ?>" tabindex="1">
												<option value="" data-placeholder="请选择"></option>
												<option value="A">A开户入金</option>
												<option value="B">B开户未入金</option>
												<option value="C">C意向客户</option>
												<option value="D">D待跟进</option>
												<option value="E">E无意向</option>
												<option value="F">F空号错号</option>
											</select>
										</div>
                                    </div>
                                    <div class="control-group">
