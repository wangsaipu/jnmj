<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:90:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/kefuconsumer/add.html";i:1537860132;s:87:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/header.html";i:1537169502;s:84:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/top.html";i:1537169502;s:85:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/left.html";i:1537169502;s:84:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/nav.html";i:1537169502;s:87:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/footer.html";i:1537348303;s:94:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/add/footer_js.html";i:1537169500;s:95:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/public_js/file.html";i:1537169502;}*/ ?>
<!DOCTYPE html>
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="<?php echo url('kefuconsumer/index'); ?>">客户数据</a>
								<i class="icon-angle-right"></i>
							</li>
							...
							<div class="portlet-body form">
								<form action="<?php echo url('add'); ?>" method='post' id="form_sample_2" class="form-horizontal">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select  class="span2 chosen" data-with-diselect="1" name="qudao" data-placeholder="请选择" tabindex="1">
                                                <option value="" data-placeholder="请选择"></option>
                                                <option value="手机抓取">手机抓取</option>
                                                <option value="QQ抓取">QQ抓取</option>
                                                <option value="微信数据">微信数据</option>
                                                <option value="高质数据">高质数据</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="cname" data-required="1" class="span6 m-wrap" placeholder="请输入客户姓名">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">手机号<span class="required">*</span></label>
                                        <div class="controls">
                                            <input type="text" name="phonenum" data-required="1" class="span6 m-wrap" placeholder="请输入手机号">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">QQ号码<span class="required">*</span></label>
                                        <div class="controls">
                                            <input type="text" name="qq" data-required="1" class="span6 m-wrap" placeholder="请输入QQ号码">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">微信号<span class="required">*</span></label>
                                        <div class="controls">
                                            <input type="text" name="wx" data-required="1" class="span6 m-wrap" placeholder="请输入微信号">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">职业<span class="required">*</span></label>
                                        <div class="controls">
                                            <input type="text" name="job" data-required="1" class="span6 m-wrap" placeholder="请输入微信号">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">地区<span class="required">*</span></label>
                                        <div class="controls">
                                            <input type="text" name="place" data-required="1" class="span6 m-wrap" placeholder="请输入地区">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">来路<span class="required">*</span></label>
                                        <div class="controls">
                                            <input type="text" name="road" data-required="1" class="span6 m-wrap" placeholder="请输入来路">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                    ...
                                    <!--<div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="state" data-required="1" class="span6 m-wrap" placeholder="请输入数据状态">
                                        </div>
                                    </div>-->
                                    <div class="control-group">
                                        <label class="control-label">数据状态<span class="required">*</span></label>
                                        <div class="controls">
                                            <select  class="span2 chosen" data-with-diselect="1" name="state" data-placeholder="请选择" tabindex="1">
                                                <option value="" data-placeholder="请选择"></option>
                                                <option value="A">A重点意向客户</option>
                                                <option value="B">B一般意向客户</option>
                                                <option value="C">C无意向客户</option>
                                                <option value="D">D空号或停机</option>
                                                <option value="E">E数据流转客户</option>
                                                <option value="F">F数据回收客户</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="control-group">
