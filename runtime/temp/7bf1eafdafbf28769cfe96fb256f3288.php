                ...
                <div class="tabbable tabbable-custom tabbable-full-width">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="<?php echo url('kefusll/index'); ?>">400电话</a></li>
                            ...
                            <li class="active"><a href="<?php echo url('kefuphone/index'); ?>">大数据</a></li>
