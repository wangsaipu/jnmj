<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:85:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/index/index.html";i:1537169504;s:87:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/header.html";i:1537169502;s:84:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/top.html";i:1537169503;s:85:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/left.html";i:1537169502;s:87:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/footer.html";i:1537348305;}*/ ?>
<!DOCTYPE html>
...
<title>丹耀后台管理系统</title>
<!-- 备忘录的插件 -->

<link rel="stylesheet" href="<?php echo \think\Config::get('cms_resource'); ?>/css/documentation.css?12" type="text/css" />
<link rel="stylesheet" href="<?php echo \think\Config::get('cms_resource'); ?>/css/jalendar.css?121" type="text/css" />
<!--  -->
</head>
...
<script type="text/javascript">
	...
	<script src="<?php echo \think\Config::get('cms_resource'); ?>/js/jquery.vmap.js" type="text/javascript"></script>   
	<script src="<?php echo \think\Config::get('cms_resource'); ?>/js/jquery.vmap.russia.js" type="text/javascript"></script>
	<script src="<?php echo \think\Config::get('cms_resource'); ?>/js/jquery.vmap.world.js" type="text/javascript"></script>
	<script src="<?php echo \think\Config::get('cms_resource'); ?>/js/jquery.vmap.europe.js" type="text/javascript"></script>
	<script src="<?php echo \think\Config::get('cms_resource'); ?>/js/jquery.vmap.germany.js" type="text/javascript"></script>
	<script src="<?php echo \think\Config::get('cms_resource'); ?>/js/jquery.vmap.usa.js" type="text/javascript"></script>
	<script src="<?php echo \think\Config::get('cms_resource'); ?>/js/jquery.vmap.sampledata.js" type="text/javascript"></script>  
	<script src="<?php echo \think\Config::get('cms_resource'); ?>/js/jquery.flot.js" type="text/javascript"></script>
	<script src="<?php echo \think\Config::get('cms_resource'); ?>/js/jquery.flot.resize.js" type="text/javascript"></script>
	<script src="<?php echo \think\Config::get('cms_resource'); ?>/js/jquery.pulsate.min.js" type="text/javascript"></script>
	<script src="<?php echo \think\Config::get('cms_resource'); ?>/js/date.js" type="text/javascript"></script>
	<script src="<?php echo \think\Config::get('cms_resource'); ?>/js/daterangepicker.js" type="text/javascript"></script>     
	<script src="<?php echo \think\Config::get('cms_resource'); ?>/js/jquery.gritter.js" type="text/javascript"></script>
	<script src="<?php echo \think\Config::get('cms_resource'); ?>/js/fullcalendar.min.js" type="text/javascript"></script>
	<script src="<?php echo \think\Config::get('cms_resource'); ?>/js/jquery.easy-pie-chart.js" type="text/javascript"></script>
	<script src="<?php echo \think\Config::get('cms_resource'); ?>/js/jquery.sparkline.min.js" type="text/javascript"></script>  
	<!-- 备忘录的插件 -->
	<script type="text/javascript" src="<?php echo \think\Config::get('cms_resource'); ?>/js/jalendar.js?1211111/"></script>     
	<!-- 备忘录的插件 -->
	<script src="<?php echo \think\Config::get('cms_resource'); ?>/js/index.js" type="text/javascript"></script>  
	<script type="text/javascript">
