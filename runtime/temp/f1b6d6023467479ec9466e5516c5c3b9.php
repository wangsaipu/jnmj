                    ...
                    <div class="portlet-body no-more-tables" style='overflow:auto'>
                        ...
                        <form action="<?php echo url('index'); ?>" id='searchForm' method='post' class="span5">
                            ...
                            <div class="input-append">
                                <input class="m-wrap" type="text" name='cname' value='<?php echo (isset($cname) && ($cname !== '')?$cname:''); ?>' placeholder='姓名'>
                                <input class="m-wrap" type="text" name='phonenum' value='<?php echo (isset($phone) && ($phone !== '')?$phone:''); ?>' placeholder='手机号码'>
                        ...
                        <table class="table table-striped table-bordered table-hover table-full-width  table-condensed cf" id="sample_1">
                            ...
                            <tr data-id='<?php echo $info['id']; ?>'>
                                ...
                                <td data-title="姓名" class="numeric"><?php echo (isset($info['cname']) && ($info['cname'] !== '')?$info['cname']:''); ?></td>
                                <td data-title="手机号" class="numeric" style="width:10%;"><span class="hideen" style="padding:1% 33% 2% 1%"><?php echo (isset($info['phone']) && ($info['phone'] !== '')?$info['phone']:''); ?></span><span class="show" style="display: none;"><?php echo (isset($info['phonenum']) && ($info['phonenum'] !== '')?$info['phonenum']:''); ?></span></td>
                                <td data-title="QQ号码" class="numeric"><?php echo (isset($info['qq']) && ($info['qq'] !== '')?$info['qq']:''); ?></td>
                                <td data-title="微信号" class="numeric"><?php echo (isset($info['wx']) && ($info['wx'] !== '')?$info['wx']:''); ?></td>
                                <td data-title="关键词" class="numeric"><?php echo (isset($info['keyword']) && ($info['keyword'] !== '')?$info['keyword']:''); ?></td>
                                <td data-title="地区" class="numeric"><?php echo (isset($info['place']) && ($info['place'] !== '')?$info['place']:''); ?></td>
                                <td data-title="职业" class="numeric"><?php echo (isset($info['job']) && ($info['job'] !== '')?$info['job']:''); ?></td>
                                <td data-title="后台来路" class="numeric"><?php echo (isset($info['road']) && ($info['road'] !== '')?$info['road']:''); ?></td>
                                <td data-title="来路渠道" class="numeric"><?php echo (isset($info['qudao']) && ($info['qudao'] !== '')?$info['qudao']:''); ?></td>
                                <td data-title="时间" class="numeric"><?php echo (isset($info['createtime']) && ($info['createtime'] !== '')?$info['createtime']:''); ?></td>
                                <td data-title="负责人" class="numeric"><?php echo (isset($info['kid']) && ($info['kid'] !== '')?$info['kid']:''); ?></td>
                                <td data-title="跟进情况" class="numeric"><?php echo (isset($info['state']) && ($info['state'] !== '')?$info['state']:''); ?></td>
                                <td data-title="所属团队" class="numeric"><?php echo (isset($info['team']) && ($info['team'] !== '')?$info['team']:''); ?></td>
                                <td data-title="备注" class="numeric"><?php echo (isset($info['beizhu']) && ($info['beizhu'] !== '')?$info['beizhu']:''); ?></td>
                                <td data-title="操作">
                        ...
                        <div id="select" style="width:160px;height: 50px;position: relative;left: 154px;bottom: 26px; ">
...
<script type="text/javascript">
    $(function(){
      ...
      //      var options=$("#test option:selected");
       //    location.href = "<?php echo url('index'); ?>?id="+options.val();
       // });
