									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<label class="checkbox line">
												<input type="radio" name="is_super"  value="0" checked />业务员
											</label>
											<label class="checkbox line">
												<input type="radio" name="is_super"  value="2"/>部门主管
											</label>
											<label class="checkbox line">
