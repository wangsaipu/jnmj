                    ...
                    <div class="portlet-body no-more-tables" style='overflow:auto'>
                        ...
                        <table class="table table-striped table-bordered table-hover table-full-width  table-condensed cf" id="sample_1">
                            ...
                            <tr data-id='<?php echo $info['id']; ?>'>
                                ...
                                <td data-title="员工名称" class="numeric"><?php echo (isset($info['pid']) && ($info['pid'] !== '')?$info['pid']:''); ?></td>
                                <td data-title="所在部门" class="numeric"><?php echo (isset($info['cpdq']) && ($info['cpdq'] !== '')?$info['cpdq']:''); ?></td>
                                <td data-title="代理记账" class="numeric"><?php echo (isset($info['xssl']) && ($info['xssl'] !== '')?$info['xssl']:''); ?></td>
                                <td data-title="社保公积金服务" class="numeric"><?php echo (isset($info['sale_total']) && ($info['sale_total'] !== '')?$info['sale_total']:''); ?></td>
                                <td data-title="商标注册" class="numeric"><?php echo (isset($info['average_price']) && ($info['average_price'] !== '')?$info['average_price']:''); ?></td>
                                <td data-title="其他产品" class="numeric"><?php echo (isset($info['coll_price']) && ($info['coll_price'] !== '')?$info['coll_price']:''); ?></td>
                                <td data-title="合同总额" class="numeric"><?php echo (isset($info['pid']) && ($info['pid'] !== '')?$info['pid']:''); ?></td>
                                <td data-title="累计有效收入（毛利）" class="numeric"><?php echo (isset($info['cpdq']) && ($info['cpdq'] !== '')?$info['cpdq']:''); ?></td>
                                <td data-title="累计实收" class="numeric"><?php echo (isset($info['xssl']) && ($info['xssl'] !== '')?$info['xssl']:''); ?></td>
                                <td data-title="累计支出" class="numeric"><?php echo (isset($info['sale_total']) && ($info['sale_total'] !== '')?$info['sale_total']:''); ?></td>
