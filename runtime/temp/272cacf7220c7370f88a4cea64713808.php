					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="<?php echo url('kefuphone/index'); ?>">手机数据</a>
								<i class="icon-angle-right"></i>
							</li>
							...
							<div class="portlet-body form">
								<form action="<?php echo url('update'); ?>" method='post' id="form_sample_2" class="form-horizontal">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="kid" data-required="1" class="span6 m-wrap" placeholder="客服姓名" value="<?php echo (isset($info['kid']) && ($info['kid'] !== '')?$info['kid']:''); ?>">
										</div>
									</div>
									<div class="control-group">
