<?php if (!defined('THINK_PATH')) exit(); /*a:12:{s:85:"D:\phpstudy_pro\WWW\www.aimier.com\public/../application/cms\view\product\update.html";i:1597730241;s:84:"D:\phpstudy_pro\WWW\www.aimier.com\public/../application/cms\view\common\header.html";i:1537169502;s:81:"D:\phpstudy_pro\WWW\www.aimier.com\public/../application/cms\view\common\top.html";i:1537169502;s:82:"D:\phpstudy_pro\WWW\www.aimier.com\public/../application/cms\view\common\left.html";i:1596508691;s:81:"D:\phpstudy_pro\WWW\www.aimier.com\public/../application/cms\view\common\nav.html";i:1537169502;s:89:"D:\phpstudy_pro\WWW\www.aimier.com\public/../application/cms\view\common\update\file.html";i:1537169502;s:90:"D:\phpstudy_pro\WWW\www.aimier.com\public/../application/cms\view\common\update\files.html";i:1537169502;s:84:"D:\phpstudy_pro\WWW\www.aimier.com\public/../application/cms\view\common\footer.html";i:1541236459;s:95:"D:\phpstudy_pro\WWW\www.aimier.com\public/../application/cms\view\common\public_js\js_tmpl.html";i:1537169502;s:98:"D:\phpstudy_pro\WWW\www.aimier.com\public/../application/cms\view\common\public_js\fileupload.html";i:1537169502;s:91:"D:\phpstudy_pro\WWW\www.aimier.com\public/../application/cms\view\common\add\footer_js.html";i:1537169500;s:92:"D:\phpstudy_pro\WWW\www.aimier.com\public/../application/cms\view\common\public_js\file.html";i:1537169502;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            ...
                            <a href="<?php echo url('product/index'); ?>">客户资料</a>
                            <i class="icon-angle-right"></i>
                        </li>
                        ...
                        <div class="portlet-body form">
                            <form action="<?php echo url('update'); ?>" method='post' id="form_sample_2" class="form-horizontal">
                                ...
                                <div class="control-group">
                                    <label class="control-label">产品状态<span class="required">*</span></label>
                                    <div class="controls">
                                        <select  class="span2 chosen" data-with-diselect="1" name="state" data-placeholder="是" tabindex="1" value="<?php echo (isset($info['state']) && ($info['state'] !== '')?$info['state']:''); ?>">
                                            <!--<option value="1" data-placeholder="是"></option>-->
                                ...
                                <div class="control-group">
                                    <label class="control-label">产品板块<span class="required">*</span></label>
                                    <div class="controls">
                                        <input type="text" name="service_type" data-required="1" class="span6 m-wrap" placeholder="请选择" value="<?php echo (isset($info['service_type']) && ($info['service_type'] !== '')?$info['service_type']:''); ?>">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">产品名称<span class="required">*</span></label>
                                    <div class="controls">
                                        <input type="text" name="p_name" data-required="1" class="span6 m-wrap" placeholder="请输入" value="<?php echo (isset($info['p_name']) && ($info['p_name'] !== '')?$info['p_name']:''); ?>">
                                    </div>
                                </div>

                                <div class="control-group">
                                    <label class="control-label">推荐价格（元）<span class="required">*</span></label>
                                    <div class="controls">
                                        <input style="width: 5%" type="text" name="min_price" data-required="1" class="span6 m-wrap" placeholder="最低价" value="<?php echo (isset($info['min_price']) && ($info['min_price'] !== '')?$info['min_price']:''); ?>">
                                        ~
                                        <input style="width: 5%" type="text" name="max_price" data-required="1" class="span6 m-wrap" placeholder="最高价" value="<?php echo (isset($info['max_price']) && ($info['max_price'] !== '')?$info['max_price']:''); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select  class="span2 chosen" data-with-diselect="1" name="unit" data-placeholder="请选择" tabindex="1" value="<?php echo (isset($info['unit']) && ($info['unit'] !== '')?$info['unit']:''); ?>">
                                            <option value="" data-placeholder="请选择"></option>
                                            <option value="1">次</option>
                                            <option value="2">元/天/建筑平米</option>
                                            <option value="3">月</option>
                                            <option value="4">人/天</option>
                                            <option value="5">年</option>
                                            <option value="6">台</option>
                                            <option value="7">课时</option>
                                            <option value="8">个</option>
                                            <option value="9">单</option>
                                            <option value="10">元/月</option>
                                        </select>
                                    </div>
                                </div>

                                <div class="control-group">
                                    <label class="control-label">是否为纸质合同：<span class="required"></span></label>
                                    <div class="controls">
                                        <select  class="span2 chosen" data-with-diselect="1" name="or_zzht" data-placeholder="请选择" tabindex="1" value="<?php echo (isset($info['or_zzht']) && ($info['or_zzht'] !== '')?$info['or_zzht']:''); ?>">
                                            <option value="" data-placeholder="请选择"></option>
                                            <option value="1">是</option>
                                            <option value="0">否</option>
                                        </select>
                                ...
                                <div class="control-group">
                                    <label class="control-label">是否同步云账房<span class="required"></span></label>
                                    <div class="controls">
                                        <select  class="span2 chosen" data-with-diselect="1" name="or_tbyzf" data-placeholder="请选择" tabindex="1" value="<?php echo (isset($info['or_tbyzf']) && ($info['or_tbyzf'] !== '')?$info['or_tbyzf']:''); ?>">
                                            <option value="" data-placeholder="请选择"></option>
                                            <option value="1">是</option>
                                            <option value="0">否</option>
                                        </select>
                                ...
                                <div class="control-group">
                                    <label class="control-label">描述说明：<span class="required"></span></label>
                                    <div class="controls">
                                        <input type="text" name="describe" data-required="1" class="span6 m-wrap" placeholder="" value="<?php echo (isset($info['describe']) && ($info['describe'] !== '')?$info['describe']:''); ?>">
                                    </div>
                                </div>
