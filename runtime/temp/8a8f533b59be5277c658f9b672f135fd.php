<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:91:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/kstatistics/index.html";i:1537169506;s:87:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/header.html";i:1537169502;s:84:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/top.html";i:1537169503;s:85:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/left.html";i:1537169502;s:98:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/table/show_column.html";i:1537169503;s:87:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/footer.html";i:1537348305;s:99:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/public_js/js_table.html";i:1537169502;}*/ ?>
<!DOCTYPE html>
                    ...
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body no-more-tables" style='overflow:auto'>
                            ...
                            <table class="table table-striped table-bordered table-hover table-full-width  table-condensed cf" id="sample_1">
                                ...
                                <tr data-id=''>
                                    <td data-title="序号" class="numeric" style="text-align: center"><nobr><?php echo $v['name']; ?></nobr></td>

                                    <td data-title="" class="numeric" style="text-align: center"><nobr><?php echo (isset($bucket[0][$v['name']]) && ($bucket[0][$v['name']] !== '')?$bucket[0][$v['name']]: '0'); ?></nobr></td>
                                    <td data-title="" class="numeric" style="text-align: center"><nobr><?php echo (isset($bucket[1][$v['name']]) && ($bucket[1][$v['name']] !== '')?$bucket[1][$v['name']]: '0'); ?></nobr></td>
                                    <td data-title="" class="numeric" style="text-align: center"><nobr><?php echo (isset($bucket[2][$v['name']]) && ($bucket[2][$v['name']] !== '')?$bucket[2][$v['name']]: '0'); ?></nobr></td>
                                    <td data-title="" class="numeric" style="text-align: center"><nobr><?php echo (isset($bucket[3][$v['name']]) && ($bucket[3][$v['name']] !== '')?$bucket[3][$v['name']]: '0'); ?></nobr></td>
                                    <td data-title="" class="numeric" style="text-align: center"><nobr><?php echo (isset($bucket[4][$v['name']]) && ($bucket[4][$v['name']] !== '')?$bucket[4][$v['name']]: '0'); ?></nobr></td>
                                </tr>
