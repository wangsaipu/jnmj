<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:85:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/kefuswt/add.html";i:1537860132;s:87:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/header.html";i:1537169502;s:84:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/top.html";i:1537169503;s:85:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/left.html";i:1537169502;s:84:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/nav.html";i:1537169502;s:87:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/footer.html";i:1537348305;s:94:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/add/footer_js.html";i:1537169501;s:95:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/public_js/file.html";i:1537169502;}*/ ?>
<!DOCTYPE html>
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="<?php echo url('kefuswt/index'); ?>">客户数据</a>
								<i class="icon-angle-right"></i>
							</li>
							...
							<div class="portlet-body form">
								<form action="<?php echo url('add'); ?>" method='post' id="form_sample_2" class="form-horizontal">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="keyword" data-required="1" class="span6 m-wrap" placeholder="请输入微信号">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">地区<span class="required">*</span></label>
                                        <div class="controls">
                                            <input type="text" name="area" data-required="1" class="span6 m-wrap" placeholder="请输入地区">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">来路<span class="required">*</span></label>
                                        <div class="controls">
                                            <input type="text" name="inurl" data-required="1" class="span6 m-wrap" placeholder="请输入来路">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">客服SEO<span class="required">*</span></label>
                                        <div class="controls">
                                            <input type="text" name="kid" data-required="1" class="span6 m-wrap" placeholder="请输入客服" value="<?php echo \think\Session::get('cmsuser')['name']; ?>">
                                        </div>
                                    </div>
                                    <!--<div class="control-group">
