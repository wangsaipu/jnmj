            ...
            <div class="row-fluid inbox">
                <div class="tabbable tabbable-custom tabbable-full-width">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="<?php echo url('kefuzhao/index'); ?>">招商平台</a></li>
								...
								<label>
									...
									<tr>
                                        ...
                                        <tr data-id='<?php echo $info['id']; ?>'>
                                            ...
                                            <td data-title="时间" class="numeric"><?php echo (isset($info['endtime']) && ($info['endtime'] !== '')?$info['endtime']:''); ?></td>
