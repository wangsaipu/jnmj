                    ...
                    <div class="portlet-body no-more-tables" style='overflow:auto'>
                        ...
                        <table class="table table-striped table-bordered table-hover table-full-width  table-condensed cf" id="sample_1">
                            ...
                            <tr data-id='<?php echo $info['id']; ?>'>
                                ...
                                <td data-title="支出事项" class="numeric"><?php echo (isset($info['expend_matter']) && ($info['expend_matter'] !== '')?$info['expend_matter']:''); ?></td>
                                <td data-title="支出科目" class="numeric"><?php echo (isset($info['expend_sub']) && ($info['expend_sub'] !== '')?$info['expend_sub']:''); ?></td>
                                ...
                                <td data-title="实收" class="numeric"><?php echo (isset($info['shishou']) && ($info['shishou'] !== '')?$info['shishou']:''); ?></td>
                                <td data-title="申请金额" class="numeric"><?php echo (isset($info['apply_money']) && ($info['apply_money'] !== '')?$info['apply_money']:''); ?></td>
                                <td data-title="备注" class="numeric"><?php echo (isset($info['mark']) && ($info['mark'] !== '')?$info['mark']:''); ?></td>
                                <td data-title="附件" class="numeric"><?php echo (isset($info['file']) && ($info['file'] !== '')?$info['file']:''); ?></td>
                                <td data-title="状态" class="numeric"><?php echo (isset($info['state']) && ($info['state'] !== '')?$info['state']:''); ?></td>
                                <td data-title="申请人" class="numeric"><?php echo (isset($info['applicant']) && ($info['applicant'] !== '')?$info['applicant']:''); ?></td>
                                <td data-title="申请时间" class="numeric"><?php echo (isset($info['apply_time']) && ($info['apply_time'] !== '')?$info['apply_time']:''); ?></td>
                                <td data-title="出纳审核人" class="numeric"><?php echo (isset($info['cashier_shr']) && ($info['cashier_shr'] !== '')?$info['cashier_shr']:''); ?></td>
                                <td data-title="支出时间" class="numeric"><?php echo (isset($info['expenditure_time']) && ($info['expenditure_time'] !== '')?$info['expenditure_time']:''); ?></td>
                                <td data-title="付款公司" class="numeric"><?php echo (isset($info['pay_company']) && ($info['pay_company'] !== '')?$info['pay_company']:''); ?></td>
                                <td data-title="付款账号" class="numeric"><?php echo (isset($info['pay_number']) && ($info['pay_number'] !== '')?$info['pay_number']:''); ?></td>
