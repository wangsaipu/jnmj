                    ...
                    <div class="portlet-body no-more-tables" style='overflow:auto'>
                        ...
                        <table class="table table-striped table-bordered table-hover table-full-width  table-condensed cf" id="sample_1">
                            ...
                            <tr data-id='<?php echo $info['id']; ?>'>
                                ...
                                <td data-title="部门名称" class="numeric"><?php echo (isset($info['dep_name']) && ($info['dep_name'] !== '')?$info['dep_name']:''); ?></td>
                                <td data-title="当期实收" class="numeric"><?php echo (isset($info['dqss']) && ($info['dqss'] !== '')?$info['dqss']:''); ?></td>
                                <td data-title="当期支出" class="numeric"><?php echo (isset($info['dqzc']) && ($info['dqzc'] !== '')?$info['dqzc']:''); ?></td>
                                <td data-title="收支差" class="numeric"><?php echo (isset($info['szc']) && ($info['szc'] !== '')?$info['szc']:''); ?></td>
