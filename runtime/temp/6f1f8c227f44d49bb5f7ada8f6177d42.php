                    ...
                    <div class="portlet-body no-more-tables" style='overflow:auto'>
                        ...
                        <table class="table table-striped table-bordered table-hover table-full-width  table-condensed cf" id="sample_1">
                            ...
                            <tr data-id='<?php echo $info['id']; ?>'>
                                ...
                                <td data-title="合同流水号" class="numeric"><?php echo (isset($info['cid']) && ($info['cid'] !== '')?$info['cid']:''); ?></td>
                                <td data-title="合同编号" class="numeric"><?php echo (isset($info['bid']) && ($info['bid'] !== '')?$info['bid']:''); ?></td>
                                <td data-title="合同类型" class="numeric"><?php echo (isset($info['contract_type']) && ($info['contract_type'] !== '')?$info['contract_type']:''); ?></td>
                                <td data-title="续签次数" class="numeric"><?php echo (isset($info['xu_sign']) && ($info['xu_sign'] !== '')?$info['xu_sign']:''); ?></td>
                                <td data-title="本单销售代表" class="numeric"><?php echo (isset($info['ben_xsdb']) && ($info['ben_xsdb'] !== '')?$info['ben_xsdb']:''); ?></td>
                                <td data-title="本单所属部门" class="numeric"><?php echo (isset($info['ben_ssbm']) && ($info['ben_ssbm'] !== '')?$info['ben_ssbm']:''); ?></td>
                                <td data-title="本单来源分类" class="numeric"><?php echo (isset($info['ben_fl']) && ($info['ben_fl'] !== '')?$info['ben_fl']:''); ?></td>
                                <td data-title="本单来源详情" class="numeric"><?php echo (isset($info['ben_xq']) && ($info['ben_xq'] !== '')?$info['ben_xq']:''); ?></td>
                                <td data-title="首单来源分类" class="numeric"><?php echo (isset($info['file']) && ($info['file'] !== '')?$info['file']:''); ?></td>
                                <td data-title="首单来源详情" class="numeric"><?php echo (isset($info['state']) && ($info['state'] !== '')?$info['state']:''); ?></td>
                                <td data-title="签订日期" class="numeric"><?php echo (isset($info['sign_date']) && ($info['sign_date'] !== '')?$info['sign_date']:''); ?></td>
                                <td data-title="合同金额" class="numeric"><?php echo (isset($info['contract_price']) && ($info['contract_price'] !== '')?$info['contract_price']:''); ?></td>
                                <td data-title="支出预算" class="numeric"><?php echo (isset($info['expend_budget']) && ($info['expend_budget'] !== '')?$info['expend_budget']:''); ?></td>
                                <td data-title="服务金额" class="numeric"><?php echo (isset($info['service_money']) && ($info['service_money'] !== '')?$info['service_money']:''); ?></td>
                                <td data-title="月费用" class="numeric"><?php echo (isset($info['month_price']) && ($info['month_price'] !== '')?$info['month_price']:''); ?></td>
                                <td data-title="回款比例" class="numeric"><?php echo (isset($info['coll_progress']) && ($info['coll_progress'] !== '')?$info['coll_progress']:''); ?></td>
                                <td data-title="累计实收" class="numeric"><?php echo (isset($info['lj_ss']) && ($info['lj_ss'] !== '')?$info['lj_ss']:''); ?></td>
                                ...
                                <td data-title="当期实收" class="numeric"><?php echo (isset($info['dq_ss']) && ($info['dq_ss'] !== '')?$info['dq_ss']:''); ?></td>
