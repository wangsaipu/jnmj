				...
				<div class="row-fluid inbox">
                    ...
                    <div class="tabbable tabbable-custom tabbable-full-width">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a href="<?php echo url('kefuws/index'); ?>">53客服</a></li>
                            <li  class="active"><a href="<?php echo url('kefumember/index'); ?>">留言板</a></li>
                            <li><a href="<?php echo url('kefuphone/index'); ?>">被动数据</a></li>
                        ...
                        <div class="portlet box green">
                            ...
                            <form action="<?php echo url('index'); ?>" id='searchForm' method='post' class="span5">
                                ...
                                <div class="input-append">
                                    <input class="m-wrap" type="text" name='name' value='<?php echo (isset($name) && ($name !== '')?$name:''); ?>' placeholder='姓名'>
                                    <input class="m-wrap" type="text" name='phone' value='<?php echo (isset($phone) && ($phone !== '')?$phone:''); ?>' placeholder='手机号码'>
                           ...
                           <!-- <form action="<?php echo url('downLoad'); ?>" enctype="multipart/form-data" method="post" id='downLoad'>
                                ...
                                <table class="table table-striped table-bordered table-hover table-full-width  table-condensed cf" id="sample_1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr data-id='<?php echo $info['id']; ?>' class="change" >
                                            <?php if($init_index==2): ?>
                                            ...
                                            <td data-title="姓名" class="numeric"><?php echo (isset($info['name']) && ($info['name'] !== '')?$info['name']:''); ?></td>
                                            <td data-title="手机号码" class="numeric" style="width:10%;"><span style="padding:1% 50% 2% 1%" class="hideen"><?php echo (isset($info['phonenum']) && ($info['phonenum'] !== '')?$info['phonenum']:''); ?></span><span class="show" style="display: none;"><?php echo (isset($info['phone']) && ($info['phone'] !== '')?$info['phone']:''); ?></span></td>
                                            <td data-title="ip地址" class="numeric inithidden"><?php echo (isset($info['ip']) && ($info['ip'] !== '')?$info['ip']:''); ?></td>
                                            <td data-title="关键词" class="numeric"><?php echo (isset($info['keyword']) && ($info['keyword'] !== '')?$info['keyword']:''); ?></td>
                                            <td data-title="来路渠道" class="numeric inithidden"><?php echo (isset($info['Antecedents']) && ($info['Antecedents'] !== '')?$info['Antecedents']:''); ?></td>
                                            <td data-title="来路URL" class="numeric inithidden"><?php echo (isset($info['url']) && ($info['url'] !== '')?$info['url']:''); ?></td>
                                          <td data-title="项目" class="numeric"><?php echo (isset($info['lname']) && ($info['lname'] !== '')?$info['lname']:''); ?></td>
                                            ...
                                            <td data-title="客服" class="numeric"><?php echo (isset($info['kid']) && ($info['kid'] !== '')?$info['kid']:''); ?></td>
                                            ...
                                            <td data-title="操作">
                                                <a href="<?php echo url('update',array('id'=>$info['id'])); ?>"  class="btn mini purple save"><i class="icon-edit"></i> 修改</a>
                                                <!--<a   class="btn mini purple save"><i class="icon-edit"></i> 修改</a>-->
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
