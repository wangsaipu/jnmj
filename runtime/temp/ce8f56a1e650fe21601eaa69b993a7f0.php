					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="<?php echo url('dy_home/index'); ?>">首页设置管理</a> 
								<i class="icon-angle-right"></i>
							</li>
							...
							<div class="portlet-body form">
								<form action="<?php echo url('add'); ?>" method='post' id="form_sample_2" class="form-horizontal">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="dy_name" class="span6 m-wrap" placeholder="请输入名称" value="<?php echo (isset($info['dy_name']) && ($info['dy_name'] !== '')?$info['dy_name']:''); ?>">
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">别名<span class="required">*</span></label>
										<div class="controls">
											<input type="text" name="dy_bname" class="span6 m-wrap" placeholder="请输入别名" value="<?php echo (isset($info['dy_bname']) && ($info['dy_bname'] !== '')?$info['dy_bname']:''); ?>">
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">标题<span class="required">*</span></label>
										<div class="controls">
											<input type="text" name="dy_title" class="span6 m-wrap" placeholder="请输入标题" value="<?php echo (isset($info['dy_title']) && ($info['dy_title'] !== '')?$info['dy_title']:''); ?>">
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">描述<span class="required"></span></label>
										<div class="controls">
											<textarea name="dy_description" class="span6 m-wrap" placeholder="请输入描述"><?php echo (isset($info['dy_description']) && ($info['dy_description'] !== '')?$info['dy_description']:''); ?></textarea>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">关键词<span class="required"></span></label>
										<div class="controls">
											<textarea name="dy_keyword" class="span6 m-wrap" placeholder="请输入关键词"><?php echo (isset($info['dy_keyword']) && ($info['dy_keyword'] !== '')?$info['dy_keyword']:''); ?></textarea>
										</div>
									</div>
