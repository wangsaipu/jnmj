    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row-fluid inbox">
                <a style="margin-bottom: 5px;" class="btn blue"  href="<?php echo url('add'); ?>"><i class="icon-plus"></i> 新增商机</a>
                    ...
                    <div class="portlet-body no-more-tables" style='overflow:auto'>
                        ...
                        <form action="<?php echo url('index'); ?>" id='searchForm' method='post' class="span5">
                            ...
                            <div class="input-append">
                                ...
                                <input class="m-wrap" type="text" name='wechat' value='<?php echo (isset($wechat) && ($wechat !== '')?$wechat:''); ?>' placeholder='微信号'>
                        ...
                        <table class="table table-striped table-bordered table-hover table-full-width  table-condensed cf" id="sample_1">
                            ...
                            <tr data-id='<?php echo $info['id']; ?>'>
                                ...
                                <td data-title="商机概述" class="numeric"><?php echo (isset($info['b_description']) && ($info['b_description'] !== '')?$info['b_description']:''); ?></td>
                                <td data-title="优先级" class="numeric"><?php echo (isset($info['priority']) && ($info['priority'] !== '')?$info['priority']:''); ?></td>
                                <td data-title="客户喜好" class="numeric"><?php echo (isset($info['favorite']) && ($info['favorite'] !== '')?$info['favorite']:''); ?></td>
                                <td data-title="自定义标签" class="numeric"><?php echo (isset($info['diy_tags']) && ($info['diy_tags'] !== '')?$info['diy_tags']:''); ?></td>
                                <td data-title="联系人" class="numeric"><?php echo (isset($info['contacts']) && ($info['contacts'] !== '')?$info['contacts']:''); ?></td>
                                <td data-title="联系方式" class="numeric"><?php echo (isset($info['tellphone']) && ($info['tellphone'] !== '')?$info['tellphone']:''); ?></td>
                                <td data-title="客户名称" class="numeric"><?php echo (isset($info['cname']) && ($info['cname'] !== '')?$info['cname']:''); ?></td>
                                <td data-title="状态" class="numeric"><?php echo (isset($info['state']) && ($info['state'] !== '')?$info['state']:''); ?></td>
                                <td data-title="商机来源" class="numeric"><?php echo (isset($info['source']) && ($info['source'] !== '')?$info['source']:''); ?></td>
                                <td data-title="推荐方案" class="numeric"><?php echo (isset($info['case']) && ($info['case'] !== '')?$info['case']:''); ?></td>
                                <td data-title="最近跟进时间" class="numeric"><?php echo (isset($info['followup_time']) && ($info['followup_time'] !== '')?$info['followup_time']:''); ?></td>
                                <td data-title="跟进内容" class="numeric"><?php echo (isset($info['f_content']) && ($info['f_content'] !== '')?$info['f_content']:''); ?></td>
                                <td data-title="下次回访时间" class="numeric"><?php echo (isset($info['huifang_time']) && ($info['huifang_time'] !== '')?$info['huifang_time']:''); ?></td>
                                <td data-title="产品类型" class="numeric"><?php echo (isset($info['p_type']) && ($info['p_type'] !== '')?$info['p_type']:''); ?></td>
                                <td data-title="当前责任人" class="numeric"><?php echo (isset($info['respon_p']) && ($info['respon_p'] !== '')?$info['respon_p']:''); ?></td>
                                <td data-title="当前责任部门" class="numeric"><?php echo (isset($info['respon_d']) && ($info['respon_d'] !== '')?$info['respon_d']:''); ?></td>
                                <td data-title="关联合同" class="numeric"><?php echo (isset($info['ass_contract']) && ($info['ass_contract'] !== '')?$info['ass_contract']:''); ?></td>
                                <td data-title="转出人" class="numeric"><?php echo (isset($info['trans_p']) && ($info['trans_p'] !== '')?$info['trans_p']:''); ?></td>
                                <td data-title="转出部门" class="numeric"><?php echo (isset($info['trans_d']) && ($info['trans_d'] !== '')?$info['trans_d']:''); ?></td>
                                <td data-title="转出时间" class="numeric"><?php echo (isset($info['trans_time']) && ($info['trans_time'] !== '')?$info['trans_time']:''); ?></td>
                                <td data-title="创建人" class="numeric"><?php echo (isset($info['create_p']) && ($info['create_p'] !== '')?$info['create_p']:''); ?></td>
                                <td data-title="创建部门" class="numeric"><?php echo (isset($info['create_d']) && ($info['create_d'] !== '')?$info['create_d']:''); ?></td>
