					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="<?php echo url('dy_home/index'); ?>">数据状态设置</a>
								<i class="icon-angle-right"></i>
							</li>
							...
							<div class="portlet-body form">
								<form action="<?php echo url('add'); ?>" method='post' id="form_sample_2" class="form-horizontal">
									...
									<div class="control-group">
										<label class="control-label">数据状态名称<span class="required">*</span></label>
										<div class="controls">
											<input type="text" name="state" class="span6 m-wrap" placeholder="请输入数据状态名称" value="<?php echo (isset($info['state']) && ($info['state'] !== '')?$info['state']:''); ?>">
										</div>
									</div>
