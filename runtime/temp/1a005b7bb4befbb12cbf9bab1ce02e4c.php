	...
	if($('li').hasClass('<?php echo $controller__action; ?>')){
		...
		<div class="page-content">
			<div class="container-fluid">
				...
				<a style="margin-bottom: 5px;" class="btn blue" target="_black" href="<?php echo url('add'); ?>"><i class="icon-plus"></i> 添加项目信息</a>
					...
					<div class="portlet box green">
						...
						<form action="<?php echo url('index'); ?>" id='searchForm' method='post' class="span3">
							...
							<input type="text" name="name"  class='m-wrap span8' placeholder="栏目名" value='<?php echo (isset($name) && ($name !== '')?$name:''); ?>'>
							...
							<table class="table table-striped table-bordered table-hover table-full-width table-condensed  cf"  id="sample_1" >
								...
								<tbody>
									...
									<tr data-id='<?php echo $info['id']; ?>' >
										...
										<td data-column="2" data-title="栏目名" class="numeric"><nobr><?php echo (isset($info['column_name']) && ($info['column_name'] !== '')?$info['column_name']:''); ?></nobr></td>
										<td data-column="3" data-title="栏目别名" class="numeric"><nobr><?php echo (isset($info['lm_bname']) && ($info['lm_bname'] !== '')?$info['lm_bname']:''); ?></nobr></td>
										<td data-column="4" data-title="栏目目录" class="numeric"><nobr><?php echo (isset($info['lm_catalog']) && ($info['lm_catalog'] !== '')?$info['lm_catalog']:''); ?></nobr></td>
										<td data-column="5" data-title="栏目关键词" class="numeric"><nobr><?php echo (isset($info['lm_keyword']) && ($info['lm_keyword'] !== '')?$info['lm_keyword']:''); ?></nobr></td>
										<td data-column="6" data-title="栏目描述" class="numeric inithidden"><nobr><?php echo (isset($info['lm_description']) && ($info['lm_description'] !== '')?$info['lm_description']:''); ?></nobr></td>
