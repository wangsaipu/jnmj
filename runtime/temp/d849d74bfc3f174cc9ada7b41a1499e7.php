			...
			<div class="container-fluid">
				...
				<div class="row-fluid inbox">
					...
					<div class="tab-pane " id="portlet_tab3">
						<form action="<?php echo url('index'); ?>" id='searchForm' method='post'>
							<input type="text" name="username" value='<?php echo (isset($username) && ($username !== '')?$username:''); ?>' class="span2 m-wrap" placeholder="请搜索姓名" />

								<a href="javascript:;" class="btn green submit"><i class="icon-search"></i>搜索</a>
							<a href="<?php echo url('add'); ?>" target="_black" class="btn green" ><i class="icon-plus"></i> 添加管理员</a>
						</form>
					</div>
							...
							<table class="table table-striped table-bordered table-hover table-full-width table-condensed  cf"  id="sample_1" >
								...
								<tbody>
									...
									<tr data-id='<?php echo $info['id']; ?>' >
										...
										<?php endif; ?>
										<td data-column="1" data-title="ID" class="numeric"><nobr><?php echo $info['id']; ?></nobr></td>
										<td data-column="2" data-title="用户姓名" class="numeric"><nobr><?php echo $info['name']; ?></nobr></td>
										<td data-column="3" data-title="用户角色" class="numeric"><nobr><?php echo showstatus($info['is_super'],'管理员,超级管理员:0,1'); ?></nobr></td>
										...
										<td data-column="12" data-title="操作" class="numeric"><nobr>
											<div class="btn-group" style='margin-bottom:0px;'>
												...
												<ul class="dropdown-menu" >
													<li><a href="<?php echo url('update',array('id'=>$info['id'])); ?>" target="_black"><i class="icon-pencil"></i> 修改资料</a></li>
													<li>
														<a href="<?php echo url('resetpassword',array('id'=>$info['id'])); ?>" target="_black"><i class="icon-pencil"></i> 重置密码</a>
													</li>
													<?php if($info['status']==0): ?>
													<li><a href="javascript:;" class='delete' data-id='<?php echo $info['id']; ?>'><i class="icon-trash"></i> 禁用</a></li>
													<?php endif; ?>
												</ul>
											</div>
										</nobr></td>
