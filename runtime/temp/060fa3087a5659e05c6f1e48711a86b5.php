					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="<?php echo url('phone/index'); ?>">客户资料</a>
								<i class="icon-angle-right"></i>
							</li>
								...
								<form action="<?php echo url('update'); ?>" method='post' id="form_sample_2" class="form-horizontal">
                                    ...
                                    <div class="controls">
                                        <select  class="m-wrap" data-with-diselect="1" name="lid" data-placeholder="请选择项目" tabindex="1">
                                            ...
                                            <option value="2">米线</option>
                                        </select>
                                    </div>
                                   </div>
									<div class="control-group">
										<label class="control-label">客服编号<span class="required">*</span></label>
										<div class="controls">
											<input type="text" name="kid" data-required="1" class="span6 m-wrap" placeholder="请输入客服编号" value="<?php echo (isset($info['kid']) && ($info['kid'] !== '')?$info['kid']:''); ?>">
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">客户姓名<span class="required">*</span></label>
										<div class="controls">
											<input type="text" name="username" data-required="1" class="span6 m-wrap" placeholder="客户姓名" value="<?php echo (isset($info['username']) && ($info['username'] !== '')?$info['username']:''); ?>">
										</div>
									</div>
                                    <div class="control-group">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="beizhu" data-required="1" class="span6 m-wrap" placeholder="请输入备注" value="<?php echo (isset($info['beizhu']) && ($info['beizhu'] !== '')?$info['beizhu']:''); ?>">
										</div>
									</div>
