					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="<?php echo url('shic/index'); ?>">客户资料</a>
								<i class="icon-angle-right"></i>
							</li>
