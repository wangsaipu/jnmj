                    ...
                    <div class="portlet-body no-more-tables" style='overflow:auto'>
                        ...
                        <table class="table table-striped table-bordered table-hover table-full-width  table-condensed cf" id="sample_1">
                            ...
                            <tr data-id='<?php echo $info['id']; ?>'>
                                ...
                                <td data-title="渠道商名称" class="numeric"><?php echo (isset($info['channel_name']) && ($info['channel_name'] !== '')?$info['channel_name']:''); ?></td>
                                <td data-title="联系人" class="numeric"><?php echo (isset($info['contact']) && ($info['contact'] !== '')?$info['contact']:''); ?></td>
                                <td data-title="联系方式" class="numeric"><?php echo (isset($info['phone']) && ($info['phone'] !== '')?$info['phone']:''); ?></td>
                                <td data-title="状态" class="numeric"><?php echo (isset($info['state']) && ($info['state'] !== '')?$info['state']:''); ?></td>
                                <td data-title="渠道负责人" class="numeric"><?php echo (isset($info['channel_manager']) && ($info['channel_manager'] !== '')?$info['channel_manager']:''); ?></td>
                                <td data-title="资源归属" class="numeric"><?php echo (isset($info['resource']) && ($info['resource'] !== '')?$info['resource']:''); ?></td>
                                <td data-title="可见范围" class="numeric"><?php echo (isset($info['range']) && ($info['range'] !== '')?$info['range']:''); ?></td>
