                    ...
                    <div class="portlet-body no-more-tables" style='overflow:auto'>
                        ...
                        <table class="table table-striped table-bordered table-hover table-full-width  table-condensed cf" id="sample_1">
                            ...
                            <tr data-id='<?php echo $info['id']; ?>'>
                                ...
                                <td data-title="客户名称" class="numeric"><?php echo (isset($info['company']) && ($info['company'] !== '')?$info['company']:''); ?></td>
                                <td data-title="微信群" class="numeric"><?php echo (isset($info['wg_state']) && ($info['wg_state'] !== '')?$info['wg_state']:''); ?></td>
                                <td data-title="联系人" class="numeric"><?php echo (isset($info['contact']) && ($info['contact'] !== '')?$info['contact']:''); ?></td>
                                <td data-title="联系方式" class="numeric"><?php echo (isset($info['contact_tell']) && ($info['contact_tell'] !== '')?$info['contact_tell']:''); ?></td>
                                <td data-title="客户负责人" class="numeric"><?php echo (isset($info['c_person']) && ($info['c_person'] !== '')?$info['c_person']:''); ?></td>
                                <td data-title="负责人部门" class="numeric"><?php echo (isset($info['res_dep']) && ($info['res_dep'] !== '')?$info['res_dep']:''); ?></td>
                                <td data-title="所有权人" class="numeric"><?php echo (isset($info['owner']) && ($info['owner'] !== '')?$info['owner']:''); ?></td>
                                <td data-title="总合同额" class="numeric"><?php echo (isset($info['contract_total']) && ($info['contract_total'] !== '')?$info['contract_total']:''); ?></td>
                                <td data-title="总待收" class="numeric"><?php echo (isset($info['total_daishou']) && ($info['total_daishou'] !== '')?$info['total_daishou']:''); ?></td>
                                <td data-title="客户标签" class="numeric"><?php echo (isset($info['c_tags']) && ($info['c_tags'] !== '')?$info['c_tags']:''); ?></td>
                                <td data-title="客户来源类型" class="numeric"><?php echo (isset($info['c_source']) && ($info['c_source'] !== '')?$info['c_source']:''); ?></td>
                                <td data-title="主营行业" class="numeric"><?php echo (isset($info['industry']) && ($info['industry'] !== '')?$info['industry']:''); ?></td>
