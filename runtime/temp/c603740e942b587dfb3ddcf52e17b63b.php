	...
	<div class="page-content">
		<div class="container-fluid">
			...
			<div class="row-fluid inbox">
				<a style="margin-bottom: 5px;" class="btn blue"  href="<?php echo url('add'); ?>"><i class="icon-plus"></i> 添加数据状态</a>
				...
				<div class="portlet box green">
					...
					<div class="portlet-body no-more-tables" style='overflow:auto'>
						...
						<form action="<?php echo url('index'); ?>" id='searchForm' method='post' class="span3">
							...
							<input type="text" name="state"  class='m-wrap span8' placeholder="名称" value='<?php echo (isset($state) && ($state !== '')?$state:''); ?>'>
						...
						<table class="table table-striped table-bordered table-hover table-full-width table-condensed  cf"  id="sample_1" >
							...
							<tr data-id='<?php echo $info['id']; ?>' >
								...
								<td data-title="状态名称" class="numeric"><nobr><?php echo (isset($info['state']) && ($info['state'] !== '')?$info['state']:''); ?></nobr></td>
