                    ...
                    <div class="portlet-body no-more-tables" style='overflow:auto'>
                        ...
                        <table class="table table-striped table-bordered table-hover table-full-width  table-condensed cf" id="sample_1">
                            ...
                            <tr data-id='<?php echo $info['id']; ?>'>
                                ...
                                <td data-title="收款账户" class="numeric"><?php echo (isset($info['collection_acc']) && ($info['collection_acc'] !== '')?$info['collection_acc']:''); ?></td>
                                <td data-title="账单流水号" class="numeric"><?php echo (isset($info['bill_number']) && ($info['bill_number'] !== '')?$info['bill_number']:''); ?></td>
                                <td data-title="客户名称" class="numeric"><?php echo (isset($info['nid']) && ($info['nid'] !== '')?$info['nid']:''); ?></td>
                                <td data-title="收款金额" class="numeric"><?php echo (isset($info['collection_money']) && ($info['collection_money'] !== '')?$info['collection_money']:''); ?></td>
                                <td data-title="收款状态" class="numeric"><?php echo (isset($info['collection_state']) && ($info['collection_state'] !== '')?$info['collection_state']:''); ?></td>
                                <td data-title="付款账户" class="numeric"><?php echo (isset($info['payment_acc']) && ($info['payment_acc'] !== '')?$info['payment_acc']:''); ?></td>
                                <td data-title="收据编号" class="numeric"><?php echo (isset($info['receipt_number']) && ($info['receipt_number'] !== '')?$info['receipt_number']:''); ?></td>
                                <td data-title="收据凭证" class="numeric"><?php echo (isset($info['coll_voucher']) && ($info['coll_voucher'] !== '')?$info['coll_voucher']:''); ?></td>
                                <td data-title="备注" class="numeric"><?php echo (isset($info['mark']) && ($info['mark'] !== '')?$info['mark']:''); ?></td>
                                <td data-title="收款人" class="numeric"><?php echo (isset($info['payee']) && ($info['payee'] !== '')?$info['payee']:''); ?></td>
                                <td data-title="收款人部门" class="numeric"><?php echo (isset($info['payee_dep']) && ($info['payee_dep'] !== '')?$info['payee_dep']:''); ?></td>
                                <td data-title="提交时间" class="numeric"><?php echo (isset($info['submit_time']) && ($info['submit_time'] !== '')?$info['submit_time']:''); ?></td>
                                <td data-title="下次回访时间" class="numeric"><?php echo (isset($info['return_time']) && ($info['return_time'] !== '')?$info['return_time']:''); ?></td>
                                <td data-title="确认人" class="numeric"><?php echo (isset($info['confirmer']) && ($info['confirmer'] !== '')?$info['confirmer']:''); ?></td>
                                <td data-title="确认人部门" class="numeric"><?php echo (isset($info['confirmer_dep']) && ($info['confirmer_dep'] !== '')?$info['confirmer_dep']:''); ?></td>
                                <td data-title="确认时间" class="numeric"><?php echo (isset($info['confirmer_time']) && ($info['confirmer_time'] !== '')?$info['confirmer_time']:''); ?></td>
                                <td data-title="到账时间" class="numeric"><?php echo (isset($info['to_acc_time']) && ($info['to_acc_time'] !== '')?$info['to_acc_time']:''); ?></td>
