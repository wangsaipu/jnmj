					...
					<div class="portlet box green">
						...
						<form action="<?php echo url('index'); ?>" id='searchForm' method='post' class="span5">
							...
							<div class="input-append">
								...
								<input type="text" name="time1"   class="m-wrap m-ctrl-medium date-picker" placeholder="开始时间" data-date-format="yyyy-mm-dd" readOnly="true" size="16"  value="<?php echo (isset($time1) && ($time1 !== '')?$time1:''); ?>">
								<input type="text" name="time2"   class="m-wrap m-ctrl-medium date-picker" placeholder="结束时间" data-date-format="yyyy-mm-dd" readOnly="true" size="16"  value="<?php echo (isset($time2) && ($time2 !== '')?$time2:''); ?>">
								<button class="btn green submit" type="button" ><i class="icon-search"></i>查询</button>
							</div>
						</form>
						<br><br><br><br>
                        <h3>当天获取数据条数为<?php echo (isset($count ) && ($count  !== '')?$count :'0'); ?>条 </h3>
						<form action="<?php echo url('downLoad'); ?>" enctype="multipart/form-data" method="post" id='downLoad'>
							...
							<table class="table table-striped table-bordered table-hover table-full-width  table-condensed cf" id="sample_1">
								...
								<tbody>
									...
									<tr data-id='<?php echo $info['id']; ?>'>
										...
										<td data-title="手机号码" class="numeric"><?php echo (isset($info['phone']) && ($info['phone'] !== '')?$info['phone']:''); ?></td>
										<td data-title="ip地址" class="numeric"><?php echo (isset($info['ip']) && ($info['ip'] !== '')?$info['ip']:''); ?></td>
										<td data-title="关键词" class="numeric"><?php echo (isset($info['keyword']) && ($info['keyword'] !== '')?$info['keyword']:''); ?></td>
										<td data-title="来路渠道" class="numeric"><?php echo (isset($info['Antecedents']) && ($info['Antecedents'] !== '')?$info['Antecedents']:''); ?></td>
										<td data-title="来路URL" class="numeric"><?php echo (isset($info['url']) && ($info['url'] !== '')?$info['url']:''); ?></td>
                                        <td data-title="项目" class="numeric"><?php echo (isset($info['lname']) && ($info['lname'] !== '')?$info['lname']:''); ?></td>
                                        <td data-title="端口" class="numeric"><?php echo (isset($info['port']) && ($info['port'] !== '')?$info['port']:''); ?></td>
                            ...
                            <div style="width: 1000px;height: 50px;">
                                ...
                                <div style="width: 100px;height: 50px;margin-left: 1551px;margin-top: -22px;">
