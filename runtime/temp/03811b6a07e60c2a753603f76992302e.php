<?php if (!defined('THINK_PATH')) exit(); /*a:10:{s:76:"/www/wwwroot/emil_pc21_com_cn/public/../application/cms/view/shic/index.html";i:1560133607;s:79:"/www/wwwroot/emil_pc21_com_cn/public/../application/cms/view/common/header.html";i:1537169502;s:76:"/www/wwwroot/emil_pc21_com_cn/public/../application/cms/view/common/top.html";i:1537169502;s:77:"/www/wwwroot/emil_pc21_com_cn/public/../application/cms/view/common/left.html";i:1537169502;s:90:"/www/wwwroot/emil_pc21_com_cn/public/../application/cms/view/common/table/show_column.html";i:1537169502;s:88:"/www/wwwroot/emil_pc21_com_cn/public/../application/cms/view/common/table/page_size.html";i:1557211441;s:84:"/www/wwwroot/emil_pc21_com_cn/public/../application/cms/view/common/table/thead.html";i:1537169502;s:77:"/www/wwwroot/emil_pc21_com_cn/public/../application/cms/view/common/page.html";i:1537169502;s:79:"/www/wwwroot/emil_pc21_com_cn/public/../application/cms/view/common/footer.html";i:1541236459;s:91:"/www/wwwroot/emil_pc21_com_cn/public/../application/cms/view/common/public_js/js_table.html";i:1537169502;}*/ ?>
<!DOCTYPE html>
                    ...
                    <div class="portlet-body no-more-tables" style='overflow:auto'>
                        ...
                        <form action="<?php echo url('index'); ?>" id='searchForm' method='post' class="span5">
                            ...
                            <div class="input-append">
                                ...
                                <input class="m-wrap" type="text" name='phonenum' value='<?php echo (isset($phonenum) && ($phonenum !== '')?$phonenum:''); ?>' placeholder='手机号'>
                                ...
                                <select  class="m-wrap" data-with-diselect="1" name="kfname" data-placeholder="数据状态" tabindex="1">
                                    <option value="">下拉选择客服</option>
                                    <?php foreach($kefu as $k=>$fk): ?>

                                    <option value="<?php echo $fk['name']; ?>"><?php echo $fk['name']; ?></option>

                                    <?php endforeach; ?>
                                </select>
                                <select  class="m-wrap" data-with-diselect="1" name="kid" data-placeholder="客服" tabindex="1">
                                    <option value="">下拉选择</option>
                                    <?php foreach($kefu_arr as $k=>$v): ?>
                        ...
                        <table class="table table-striped table-bordered table-hover table-full-width  table-condensed cf" id="sample_1">
                            ...
                            <tr data-id='<?php echo $info['id']; ?>'>
                                ...
                                <td data-title="手机号码" class="numeric" style="width:10%;"><span style="padding:1% 60% 2% 1%" class="hideen"><?php echo (isset($info['phone1']) && ($info['phone1'] !== '')?$info['phone1']:''); ?></span><span class="show" style="display: none;"><?php echo (isset($info['phone']) && ($info['phone'] !== '')?$info['phone']:''); ?></span></td>
                                <td data-title="QQ/WX" class="numeric"><?php echo (isset($info['qq']) && ($info['qq'] !== '')?$info['qq']:''); ?></td>
                                <td data-title="关键词" class="numeric"><?php echo (isset($info['keyword']) && ($info['keyword'] !== '')?$info['keyword']:''); ?></td>
                                <td data-title="区域" class="numeric"><?php echo (isset($info['address']) && ($info['address'] !== '')?$info['address']:''); ?></td>
                                <td data-title="来源" class="numeric"><?php echo (isset($info['laiyuan']) && ($info['laiyuan'] !== '')?$info['laiyuan']:''); ?></td>
                                <td data-title="项目" class="numeric"><?php echo (isset($info['xiangmu']) && ($info['xiangmu'] !== '')?$info['xiangmu']:''); ?></td>
                                <td data-title="网谈对话" class="numeric" width="350"><?php echo (isset($info['content']) && ($info['content'] !== '')?$info['content']:''); ?></td>
                                <td data-title="时间" class="numeric"><?php echo (isset($info['createtime']) && ($info['createtime'] !== '')?$info['createtime']:''); ?></td>
                                <td data-title="最后修改时间" class="numeric"><?php echo (isset($info['endtime']) && ($info['endtime'] !== '')?$info['endtime']:''); ?></td>
                                <td data-title="客服" class="numeric"><?php echo (isset($info['kid']) && ($info['kid'] !== '')?$info['kid']:''); ?></td>
                                <?php if($info['state'] == 'A重点客户'): ?>
                                <td data-title="数据状态" class="numeric" style="background-color:#e8723b;"><?php echo (isset($info['state']) && ($info['state'] !== '')?$info['state']:''); ?></td>
                                <?php else: ?>
