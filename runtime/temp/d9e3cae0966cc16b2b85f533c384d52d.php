                    ...
                    <div class="portlet-body no-more-tables" style='overflow:auto'>
                        ...
                        <table class="table table-striped table-bordered table-hover table-full-width  table-condensed cf" id="sample_1">
                            ...
                            <tr data-id='<?php echo $info['id']; ?>'>
                                ...
                                <td data-title="认领状态" class="numeric"><?php echo (isset($info['claim_state']) && ($info['claim_state'] !== '')?$info['claim_state']:''); ?></td>
                                <td data-title="到账金额" class="numeric"><?php echo (isset($info['acc_money']) && ($info['acc_money'] !== '')?$info['acc_money']:''); ?></td>
                                <td data-title="付款账户" class="numeric"><?php echo (isset($info['pay_acc_num']) && ($info['pay_acc_num'] !== '')?$info['pay_acc_num']:''); ?></td>
                                <td data-title="待认领金额" class="numeric"><?php echo (isset($info['drl_money']) && ($info['drl_money'] !== '')?$info['drl_money']:''); ?></td>
                                <td data-title="交易编号" class="numeric"><?php echo (isset($info['trasaction_number']) && ($info['trasaction_number'] !== '')?$info['trasaction_number']:''); ?></td>
