                    ...
                    <div class="portlet-body no-more-tables" style='overflow:auto'>
                        ...
                        <table class="table table-striped table-bordered table-hover table-full-width  table-condensed cf" id="sample_1">
                            ...
                            <tr data-id='<?php echo $info['id']; ?>'>
                                ...
                                <td data-title="收款公司" class="numeric"><?php echo (isset($info['collect_company']) && ($info['collect_company'] !== '')?$info['collect_company']:''); ?></td>
                                <td data-title="支付方式" class="numeric"><?php echo (isset($info['pay_type']) && ($info['pay_type'] !== '')?$info['pay_type']:''); ?></td>
                                <td data-title="费用类型" class="numeric"><?php echo (isset($info['cost_type']) && ($info['cost_type'] !== '')?$info['cost_type']:''); ?></td>
                                <td data-title="付款状态" class="numeric"><?php echo (isset($info['pay_state']) && ($info['pay_state'] !== '')?$info['pay_state']:''); ?></td>
                                <td data-title="退款状态" class="numeric"><?php echo (isset($info['refund_state']) && ($info['refund_state'] !== '')?$info['refund_state']:''); ?></td>
                                <td data-title="到账时间" class="numeric"><?php echo (isset($info['to_acc_time']) && ($info['to_acc_time'] !== '')?$info['to_acc_time']:''); ?></td>
                                <td data-title="交易人" class="numeric"><?php echo (isset($info['trader']) && ($info['trader'] !== '')?$info['trader']:''); ?></td>
                                <td data-title="收款金额" class="numeric"><?php echo (isset($info['collection_money']) && ($info['collection_money'] !== '')?$info['collection_money']:''); ?></td>
                                <td data-title="手续费" class="numeric"><?php echo (isset($info['service_charge']) && ($info['service_charge'] !== '')?$info['service_charge']:''); ?></td>
                                <td data-title="实际收款金额" class="numeric"><?php echo (isset($info['real_coll_money']) && ($info['real_coll_money'] !== '')?$info['real_coll_money']:''); ?></td>
