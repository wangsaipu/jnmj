					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="<?php echo url('column/index'); ?>">栏目信息</a> 
								<i class="icon-angle-right"></i>
							</li>
							...
							<div class="portlet-body form">
								<form action="<?php echo url('add'); ?>" method='post' id="form_sample_2" class="form-horizontal">
									...
									<div class="control-group">
										<label class="control-label">栏目名<span class="required">*</span></label>
										<div class="controls">
											<select class="span6 m-wrap" name="classify_id">
												<option value=""></option>
												<?php echo $str; ?>
											</select>
										</div>
									...
									<div class="control-group">
										<label class="control-label">栏目别名<span class="required">*</span></label>
										<div class="controls">
											<input type="text" name="lm_bname" data-required="1" class="span6 m-wrap" placeholder="请输入栏目别名">
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">栏目目录<span class="required">*</span></label>
										<div class="controls">
											<input type="text" name="lm_catalog" data-required="1" class="span6 m-wrap" placeholder="请输入栏目目录">
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">栏目关键词<span class="required">*</span></label>
										<div class="controls">
											<input type="text" name="lm_keyword" data-required="1" class="span6 m-wrap" placeholder="请输入栏目关键词">
										</div>
									</div>

									<div class="control-group">
										<label class="control-label">栏目描述<span class="required">*</span></label>
										<div class="controls">
											<textarea class="span6 m-wrap" name="lm_description"></textarea>
										</div>
									</div>
...
<script>
	...
	jQuery(document).ready(function() {       
	   App.init();
	   var my_html = $('.add_html').html();
	   $('.add_class').click(function(){
            $('.add_html').find('.remove_class').click(function(){
				$(this).parent().remove();
			});	
			$('.add_html').append(my_html);
		});
//需要修改的部分 
		rules = {
                classify_id: {
