            ...
            <div class="row-fluid inbox">
                <div class="tabbable tabbable-custom tabbable-full-width">
                    <ul class="nav nav-tabs">
                            <li><a href="<?php echo url('kefumember/index'); ?>">高质数据</a></li>
                            <li><a href="<?php echo url('kefuswt/index'); ?>">商务通数据</a></li>
													<li><a href="<?php echo url('kefuphone//index'); ?>">被动数据</a></li>
                            <li class="active"><a href="<?php echo url('kefuqq/index'); ?>">QQ数据</a></li>
                    </ul>
                    ...
                    <div class="portlet-body no-more-tables" style='overflow:auto'>
                        ...
                        <table class="table table-striped table-bordered table-hover table-full-width  table-condensed cf" id="sample_1">
                            ...
                            <tr data-id='<?php echo $info['id']; ?>'>
                                ...
                                <td data-title="qq号码" class="numeric"><?php echo (isset($info['qqnumber']) && ($info['qqnumber'] !== '')?$info['qqnumber']:''); ?></td>
                                <td data-title="昵称" class="numeric"><?php echo (isset($info['nickname']) && ($info['nickname'] !== '')?$info['nickname']:''); ?></td>
                                <td data-title="时间" class="numeric"><?php echo (isset($info['createtime']) && ($info['createtime'] !== '')?$info['createtime']:''); ?></td>
                                <td data-title="搜索引擎" class="numeric"><?php echo (isset($info['engine']) && ($info['engine'] !== '')?$info['engine']:''); ?></td>
                                <td data-title="来路URL" class="numeric"><?php echo (isset($info['qurl']) && ($info['qurl'] !== '')?$info['qurl']:''); ?></td>
                                <td data-title="IP/归属地" class="numeric"><?php echo (isset($info['inip']) && ($info['inip'] !== '')?$info['inip']:''); ?></td>
                                ...
                                <td data-title="备注" class="numeric inithidden"><?php echo (isset($info['beizhu']) && ($info['beizhu'] !== '')?$info['beizhu']:''); ?></td>
                                <td data-title="操作">
