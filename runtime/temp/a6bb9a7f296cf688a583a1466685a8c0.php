<?php if (!defined('THINK_PATH')) exit(); /*a:12:{s:87:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/worker/update.html";i:1537434490;s:87:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/header.html";i:1537169502;s:84:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/top.html";i:1537169503;s:85:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/left.html";i:1537169502;s:84:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/nav.html";i:1537169502;s:92:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/update/file.html";i:1537169503;s:93:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/update/files.html";i:1537169503;s:87:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/footer.html";i:1537348305;s:98:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/public_js/js_tmpl.html";i:1537169502;s:101:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/public_js/fileupload.html";i:1537169502;s:94:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/add/footer_js.html";i:1537169501;s:95:"/www/wwwroot/huanlaji/os.huanlaji.com/public/../application/cms/view/common/public_js/file.html";i:1537169502;}*/ ?>
<!DOCTYPE html>
...
<script>
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="<?php echo url('worker/index'); ?>">职员管理</a> 
								<i class="icon-angle-right"></i>
							</li>
							...
							<div class="portlet-body form">
								<form action="<?php echo url('update'); ?>" method='post' id="form_sample_2" class="form-horizontal">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="username" data-required="1" class="span6 m-wrap" placeholder="请输入账号" value="<?php echo (isset($info['username']) && ($info['username'] !== '')?$info['username']:''); ?>">
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">姓名<span class="required">*</span></label>
										<div class="controls">
											<input type="text" name="name" data-required="1" class="span6 m-wrap" placeholder="请输入姓名" value="<?php echo (isset($info['name']) && ($info['name'] !== '')?$info['name']:''); ?>">
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">性别<span class="required">*</span></label>
										<div class="controls radio_valida">
											<label class="radio">
											<input type="radio" name="sex" value="1" <?php if($info['sex']==1): ?>checked="checked"<?php endif; ?> />
												男
											</label>
											<label class="radio">
											<input type="radio" name="sex" value="0" <?php if($info['sex']==0): ?>checked="checked"<?php endif; ?>  />
												女
											</label> 
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="email" data-required="1" class="span6 m-wrap" placeholder="请输入邮箱" value="<?php echo (isset($info['email']) && ($info['email'] !== '')?$info['email']:''); ?>"/>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">部门类型<span class="required">*</span></label>
										<div class="controls">
											<select  class="span2 chosen" data-with-diselect="1" name="b_id" data-placeholder="部门类型" tabindex="1">
												<option value=""></option>
						                        <?php echo new_getfkarr('bmlx','branch',$arr,[]); foreach($arr as $k=>$fk): if(isset($info['b_id'])): ?>
						                        <option value="<?php echo $fk['id']; ?>" <?php if($info['b_id']==$fk['id']): ?> selected <?php endif; ?>><?php echo $fk['bmlx']; ?></option>
						                            <?php else: ?>
						                        <option value="<?php echo $fk['id']; ?>"><?php echo $fk['bmlx']; ?></option>
						                            <?php endif; endforeach; ?>
											</select>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">出生地<span class="required"></span></label>
										<div class="controls">
											<input type="text" name="birth_address" data-required="1" class="span6 m-wrap" placeholder="请输入出生地" value="<?php echo (isset($info['birth_address']) && ($info['birth_address'] !== '')?$info['birth_address']:''); ?>"/>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">现住址<span class="required"></span></label>
										<div class="controls">
											<input type="text" name="new_address" data-required="1" class="span6 m-wrap" placeholder="请输入现住址" value="<?php echo (isset($info['new_address']) && ($info['new_address'] !== '')?$info['new_address']:''); ?>"/>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">联系方式<span class="required"></span></label>
										<div class="controls">
											<input type="text" name="phone" data-required="1" class="span6 m-wrap" placeholder="请输入联系方式" value="<?php echo (isset($info['phone']) && ($info['phone'] !== '')?$info['phone']:''); ?>"/>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">备注<span class="required"></span></label>
										<div class="controls">
											<textarea class="span6 m-wrap" name="note"><?php echo (isset($info['note']) && ($info['note'] !== '')?$info['note']:''); ?></textarea>
										</div>
									</div>
									<!-- 单图片上传只需字段代码 -->

									<?php if(!empty($file_upload_index)): foreach($file_upload_index as $column=>$name): ?>
										<div class="control-group">
											...
											<div class="controls">
												<div class="fileupload fileupload-new" data-provides="fileupload">
													<div class="fileupload-new thumbnail default_<?php echo $column; ?>" style="width: 200px; height: 150px;">
														<img <?php if((isset($info[$column]))): ?>src='<?php echo (isset($info[$column]) && ($info[$column] !== '')?$info[$column]:''); ?>'<?php else: ?> src='<?php echo \think\Config::get('cms_resource'); ?>/image/zhanwu.jpg'<?php endif; ?> alt="" />
													</div>
									...
									<!-- 多图片上传只需字段代码 -->
									<?php if(!empty($files_upload_index)): foreach($files_upload_index as $column=>$name): ?>
									<div class="control-group" id='column_<?php echo $column; ?>'>
										...
										<div class="controls">
											<div class="row-fluid fileupload-buttonbar">
												<div class="span7">
													...
													<span>添加图片</span>
													<input type="file" name="<?php echo $column; ?>[]" multiple>
													</span>
											...
											<table role="presentation" class="table table-striped">
												...
												<?php if(!empty($info[$column])): foreach(json_decode($info[$column]) as $k=>$v): ?>
												<tr class="template-download fade in">
										            <td class="preview">
										            	<input type="hidden" name='<?php echo $column; ?>[]' value="<?php echo $v; ?>">
										                <a class="fancybox-button" data-rel="fancybox-button" href="<?php echo \think\Config::get('cms_upload'); ?>/<?php echo $v; ?>" title="<?php echo $v; ?>">
										                <img src="<?php echo \think\Config::get('cms_upload'); ?>/<?php echo $v; ?>" width='100' >
										                </a>
										            </td>
										            <td class="name" >
										                <a href="<?php echo \think\Config::get('cms_upload'); ?>/<?php echo $v; ?>" title="<?php echo $v; ?>" data-gallery="gallery" download="<?php echo $v; ?>"><?php echo $v; ?></a>
										            </td>
										            <td colspan="3"></td>
											        <td class="delete">
	...
	<div class="footer hidden-print" style='background-color:#333;'>
		<div class="footer-inner" style='padding-left:1%'>
			2018 © Power by  <a href='http://www.vowkin.com' target='_blank' > Sansed</a>
		</div>
