                    ...
                    <div class="portlet-body no-more-tables" style='overflow:auto'>
                        ...
                        <table class="table table-striped table-bordered table-hover table-full-width  table-condensed cf" id="sample_1">
                            ...
                            <tr data-id='<?php echo $info['id']; ?>'>
                                ...
                                <td data-title="开票编号" class="numeric"><?php echo (isset($info['invoice_num']) && ($info['invoice_num'] !== '')?$info['invoice_num']:''); ?></td>
                                ...
                                <td data-title="发票类型" class="numeric"><?php echo (isset($info['invoice_type']) && ($info['invoice_type'] !== '')?$info['invoice_type']:''); ?></td>
                                <td data-title="开票金额" class="numeric"><?php echo (isset($info['invoice_amount']) && ($info['invoice_amount'] !== '')?$info['invoice_amount']:''); ?></td>
                                <td data-title="开票状态" class="numeric"><?php echo (isset($info['invoice_state']) && ($info['invoice_state'] !== '')?$info['invoice_state']:''); ?></td>
                                <td data-title="审批状态" class="numeric"><?php echo (isset($info['approval_state']) && ($info['approval_state'] !== '')?$info['approval_state']:''); ?></td>
                                <td data-title="发票抬头" class="numeric"><?php echo (isset($info['invoice_title']) && ($info['invoice_title'] !== '')?$info['invoice_title']:''); ?></td>
                                <td data-title="服务公司" class="numeric"><?php echo (isset($info['company']) && ($info['company'] !== '')?$info['company']:''); ?></td>
                                <td data-title="申请人" class="numeric"><?php echo (isset($info['invoice_applicant']) && ($info['invoice_applicant'] !== '')?$info['invoice_applicant']:''); ?></td>
                                <td data-title="申请时间" class="numeric"><?php echo (isset($info['invoice_apply_time']) && ($info['invoice_apply_time'] !== '')?$info['invoice_apply_time']:''); ?></td>
                                <td data-title="开票人" class="numeric"><?php echo (isset($info['drawer']) && ($info['drawer'] !== '')?$info['drawer']:''); ?></td>
                                <td data-title="开票时间" class="numeric"><?php echo (isset($info['invoice_time']) && ($info['invoice_time'] !== '')?$info['invoice_time']:''); ?></td>
                                <td data-title="社会信用代码" class="numeric"><?php echo (isset($info['scc']) && ($info['scc'] !== '')?$info['scc']:''); ?></td>
