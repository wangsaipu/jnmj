                            ...
                            <div class="portlet-body form">
                                <form action="<?php echo url('add'); ?>" method='post' id="form_sample_2" class="form-horizontal">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="phonenum" data-required="1" class="span6 m-wrap" placeholder="请输入手机号码">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label">受访URL<span class="required"></span></label>
                                        <div class="controls">
                                            <input type="text" name="ip" data-required="1" class="span6 m-wrap" placeholder="请输入受访URL">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">ip地址<span class="required"></span></label>
                                        <div class="controls">
                                            <input type="text" name="place" data-required="1" class="span6 m-wrap" placeholder="请输入ip地址">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">归属地<span class="required"></span></label>
                                        <div class="controls">
                                            <input type="text" name="place" data-required="1" class="span6 m-wrap" placeholder="请输入归属地">
                                        </div>
                                    </div>
                                    <div class="control-group">
