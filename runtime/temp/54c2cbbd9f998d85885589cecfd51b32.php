                    ...
                    <div class="portlet-body no-more-tables" style='overflow:auto'>
                        ...
                        <form action="<?php echo url('index'); ?>" id='searchForm' method='post' class="span5">
                            ...
                            <div class="input-append">
                                ...
                                <input class="m-wrap" type="text" name='keyword' value='<?php echo (isset($keyword) && ($keyword !== '')?$keyword:''); ?>' placeholder='关键词'>-->
                                <input class="m-wrap" type="text" name='qqnumber' value='<?php echo (isset($phone) && ($phone !== '')?$phone:''); ?>' placeholder='QQ号码'>
                        ...
                        <br><br><br><br>
                        <h4>当天获取数据条数为<?php echo (isset($count ) && ($count  !== '')?$count :'0'); ?>条 </h4>
                        <form action="<?php echo url('downLoad'); ?>" enctype="multipart/form-data" method="post" id='downLoad'>
                            ...
                            <span style="color:red;font-size: 14px;">按日期导出excel可修改</span>
                        </form>
                        ...
                        <table class="table table-striped table-bordered table-hover table-full-width  table-condensed cf" id="sample_1">
                            ...
                            <tr data-id='<?php echo $info['id']; ?>'>
                                ...
                                <td data-title="手机" class="numeric"><?php echo (isset($info['phonenum']) && ($info['phonenum'] !== '')?$info['phonenum']:''); ?></td>
                                <td data-title="QQ" class="numeric"><?php echo (isset($info['qqnumber']) && ($info['qqnumber'] !== '')?$info['qqnumber']:''); ?></td>
                                <td data-title="微信" class="numeric"><?php echo (isset($info['weixin']) && ($info['weixin'] !== '')?$info['weixin']:''); ?></td>
                                <td data-title="地址" class="numeric"><?php echo (isset($info['address']) && ($info['address'] !== '')?$info['address']:''); ?></td>
                                <td data-title="来源" class="numeric"><?php echo (isset($info['laiyuan']) && ($info['laiyuan'] !== '')?$info['laiyuan']:''); ?></td>
                        ...
                        <div style="width: 1000px;height: 50px;">
                            ...
                            <div style="width: 100px;height: 50px;margin-left: 1551px;margin-top: -22px;">
                                ...
                                <div id="select" style="width:160px;height: 50px;position: relative;left: 93px;bottom: 26px; ">
