					...
					<div class="span12">
						<div class="portlet box green">
							...
							<div class="portlet-body form">
								<form action="<?php echo url('mypass'); ?>" method='post' id="form_sample_2" class="form-horizontal">
									...
									<div class="control-group">
										...
										<label class="control-label">身份证号码（帐号）：</label>
									...
									<div class="control-group">
										...
										<div class="controls">
											<span class='text'><?php echo showstatus($user['is_super'],'管理员,超级管理员:0,1'); ?></span>
									...
									<div class="form-actions">
										...
										<a href="<?php echo url('index/index'); ?>" class="btn blue">返回</a>
