                    ...
                    <div class="portlet-body no-more-tables" style='overflow:auto'>
                        ...
                        <table class="table table-striped table-bordered table-hover table-full-width  table-condensed cf" id="sample_1">
                            ...
                            <tr data-id='<?php echo $info['id']; ?>'>
                                ...
                                <td data-title="签约日期" class="numeric"><?php echo (isset($info['sign_date']) && ($info['sign_date'] !== '')?$info['sign_date']:''); ?></td>
                                <td data-title="合同类型" class="numeric"><?php echo (isset($info['contract_type']) && ($info['contract_type'] !== '')?$info['contract_type']:''); ?></td>
                                <td data-title="合同状态" class="numeric"><?php echo (isset($info['contract_status']) && ($info['contract_status'] !== '')?$info['contract_status']:''); ?></td>
                                <td data-title="合同金额" class="numeric"><?php echo (isset($info['contract_money']) && ($info['contract_money'] !== '')?$info['contract_money']:''); ?></td>
                                <td data-title="合同流水号" class="numeric"><?php echo (isset($info['contract_number']) && ($info['contract_number'] !== '')?$info['contract_number']:''); ?></td>
                                <td data-title="合同编号" class="numeric"><?php echo (isset($info['bianhao']) && ($info['bianhao'] !== '')?$info['bianhao']:''); ?></td>
                                <td data-title="合同来源" class="numeric"><?php echo (isset($info['contract_source']) && ($info['contract_source'] !== '')?$info['contract_source']:''); ?></td>
