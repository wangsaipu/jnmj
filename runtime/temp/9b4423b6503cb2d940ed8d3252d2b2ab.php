                    ...
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body no-more-tables" style='overflow:auto'>
                            ...
                            <table class="table table-striped table-bordered table-hover table-full-width  table-condensed cf" id="sample_1">
                                ...
                                <tr data-id=''>
                                    <td data-title="客服" class="numeric" ><nobr><?php echo $info['name']; ?></nobr></td>
                                    <td data-title="商务通" class="numeric"><nobr><?php echo (isset($info['swt']) && ($info['swt'] !== '')?$info['swt']:'0'); ?></nobr></td>
                                    <td data-title="留言板" class="numeric"><nobr><?php echo (isset($info['member']) && ($info['member'] !== '')?$info['member']:'0'); ?></nobr></td>
                                    <td data-title="抖音资源" class="numeric"><nobr><?php echo (isset($info['douyin']) && ($info['douyin'] !== '')?$info['douyin']:'0'); ?></nobr></td>
                                    <td data-title="大数据" class="numeric"><nobr><?php echo (isset($info['phone']) && ($info['phone'] !== '')?$info['phone']:'0'); ?></nobr></td>
                                    <td data-title="400电话" class="numeric"><nobr><?php echo (isset($info['sll']) && ($info['sll'] !== '')?$info['sll']:'0'); ?></nobr></td>
                                    <td data-title="市场资源" class="numeric"><nobr><?php echo (isset($info['shic']) && ($info['shic'] !== '')?$info['shic']:'0'); ?></nobr></td>
                                    <td data-title="头条资源" class="numeric"><nobr><?php echo (isset($info['toutiao']) && ($info['toutiao'] !== '')?$info['toutiao']:'0'); ?></nobr></td>
                                    <td data-title="招商平台" class="numeric"><nobr><?php echo (isset($info['zhao']) && ($info['zhao'] !== '')?$info['zhao']:'0'); ?></nobr></td>
                                    <td data-title="自寻资源" class="numeric"><nobr><?php echo (isset($info['zixun']) && ($info['zixun'] !== '')?$info['zixun']:'0'); ?></nobr></td>
                                </tr>
                                <?php endforeach; ?>
