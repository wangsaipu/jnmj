                    ...
                    <div class="portlet-body no-more-tables" style='overflow:auto'>
                        ...
                        <table class="table table-striped table-bordered table-hover table-full-width  table-condensed cf" id="sample_1">
                            ...
                            <tr data-id='<?php echo $info['id']; ?>'>
                                ...
                                <td data-title="外勤ID" class="numeric"><?php echo (isset($info['pid']) && ($info['pid'] !== '')?$info['pid']:''); ?></td>
                                <td data-title="客户名称" class="numeric"><?php echo (isset($info['cpdq']) && ($info['cpdq'] !== '')?$info['cpdq']:''); ?></td>
                                <td data-title="任务名称" class="numeric"><?php echo (isset($info['xssl']) && ($info['xssl'] !== '')?$info['xssl']:''); ?></td>
                                <td data-title="办事事项" class="numeric"><?php echo (isset($info['sale_total']) && ($info['sale_total'] !== '')?$info['sale_total']:''); ?></td>
                                <td data-title="办事地址" class="numeric"><?php echo (isset($info['average_price']) && ($info['average_price'] !== '')?$info['average_price']:''); ?></td>
                                <td data-title="备注" class="numeric"><?php echo (isset($info['coll_price']) && ($info['coll_price'] !== '')?$info['coll_price']:''); ?></td>
                                <td data-title="状态" class="numeric"><?php echo (isset($info['pid']) && ($info['pid'] !== '')?$info['pid']:''); ?></td>
                                <td data-title="负责人" class="numeric"><?php echo (isset($info['cpdq']) && ($info['cpdq'] !== '')?$info['cpdq']:''); ?></td>
                                <td data-title="负责人部门" class="numeric"><?php echo (isset($info['xssl']) && ($info['xssl'] !== '')?$info['xssl']:''); ?></td>
                                <td data-title="创建人" class="numeric"><?php echo (isset($info['sale_total']) && ($info['sale_total'] !== '')?$info['sale_total']:''); ?></td>
                                <td data-title="创建人部门" class="numeric"><?php echo (isset($info['average_price']) && ($info['average_price'] !== '')?$info['average_price']:''); ?></td>
                                <td data-title="创建时间" class="numeric"><?php echo (isset($info['coll_price']) && ($info['coll_price'] !== '')?$info['coll_price']:''); ?></td>
                                <td data-title="办完时间" class="numeric"><?php echo (isset($info['xssl']) && ($info['xssl'] !== '')?$info['xssl']:''); ?></td>
                                <td data-title="服务公司" class="numeric"><?php echo (isset($info['sale_total']) && ($info['sale_total'] !== '')?$info['sale_total']:''); ?></td>
                                <td data-title="汇报明细" class="numeric"><?php echo (isset($info['average_price']) && ($info['average_price'] !== '')?$info['average_price']:''); ?></td>
                                <td data-title="汇报时间" class="numeric"><?php echo (isset($info['coll_price']) && ($info['coll_price'] !== '')?$info['coll_price']:''); ?></td>
