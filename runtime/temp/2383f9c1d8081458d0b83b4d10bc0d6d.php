                ...
                <div class="tabbable tabbable-custom tabbable-full-width">
                    <ul class="nav nav-tabs">
                        <li><a href="<?php echo url('kefuswt/index'); ?>">商务通</a></li>
                            ...
                            <li class="active"><a href="<?php echo url('kefuphone/index'); ?>">被动数据</a></li>
								...
								<label>
									...
									<tr>
                                        ...
                                        <tr data-id='<?php echo $info['id']; ?>'>
                                            ...
                                            <td data-title="手机号码" class="numeric" style="width:10%;"><span style="padding:1% 50% 2% 1%" class="hideen"><?php echo (isset($info['phone']) && ($info['phone'] !== '')?$info['phone']:''); ?></span><span class="show" style="display: none;"><?php echo (isset($info['phonenum']) && ($info['phonenum'] !== '')?$info['phonenum']:''); ?></span></td>
