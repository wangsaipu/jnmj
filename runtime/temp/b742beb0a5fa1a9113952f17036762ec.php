                            ...
                            <div class="portlet-body form">
                                <form action="<?php echo url('add'); ?>" method='post' id="form_sample_2" class="form-horizontal">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="qqnumber" data-required="1" class="span6 m-wrap" placeholder="请输入QQ号码">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">微信<span class="required">*</span></label>
                                        <div class="controls">
                                            <input type="text" name="weixin" data-required="1" class="span6 m-wrap" placeholder="请输入微信号码">
                                        </div>
                                    </div>
                                    <div class="control-group">
