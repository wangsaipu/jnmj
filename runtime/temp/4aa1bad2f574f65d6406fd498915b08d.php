                    ...
                    <div class="portlet-body no-more-tables" style='overflow:auto'>
                        ...
                        <table class="table table-striped table-bordered table-hover table-full-width  table-condensed cf" id="sample_1">
                            ...
                            <tr data-id='<?php echo $info['id']; ?>'>
                                ...
                                <td data-title="产品大全" class="numeric"><?php echo (isset($info['cpdq']) && ($info['cpdq'] !== '')?$info['cpdq']:''); ?></td>
                                <td data-title="销售数量（含赠送）" class="numeric"><?php echo (isset($info['xssl']) && ($info['xssl'] !== '')?$info['xssl']:''); ?></td>
                                <td data-title="销售总额" class="numeric"><?php echo (isset($info['sale_total']) && ($info['sale_total'] !== '')?$info['sale_total']:''); ?></td>
                                <td data-title="平均成交金额" class="numeric"><?php echo (isset($info['average_price']) && ($info['average_price'] !== '')?$info['average_price']:''); ?></td>
                                <td data-title="收款金额" class="numeric"><?php echo (isset($info['coll_price']) && ($info['coll_price'] !== '')?$info['coll_price']:''); ?></td>
