                    ...
                    <div class="portlet-body no-more-tables" style='overflow:auto'>
                        ...
                        <table class="table table-striped table-bordered table-hover table-full-width  table-condensed cf" id="sample_1">
                            ...
                            <tr data-id='<?php echo $info['id']; ?>'>
                                ...
                                <td data-title="评价人" class="numeric"><?php echo (isset($info['evaluator']) && ($info['evaluator'] !== '')?$info['evaluator']:''); ?></td>
                                <td data-title="客户公司" class="numeric"><?php echo (isset($info['c_company']) && ($info['c_company'] !== '')?$info['c_company']:''); ?></td>
                                <td data-title="办理业务" class="numeric"><?php echo (isset($info['blyw']) && ($info['blyw'] !== '')?$info['blyw']:''); ?></td>
                                <td data-title="评分" class="numeric"><?php echo (isset($info['score']) && ($info['score'] !== '')?$info['score']:''); ?></td>
                                <td data-title="有无额外收费" class="numeric"><?php echo (isset($info['ywewsf']) && ($info['ywewsf'] !== '')?$info['ywewsf']:''); ?></td>
                                <td data-title="意见和建议" class="numeric"><?php echo (isset($info['yjjy']) && ($info['yjjy'] !== '')?$info['yjjy']:''); ?></td>
                                <td data-title="业务人员" class="numeric"><?php echo (isset($info['bus_person']) && ($info['bus_person'] !== '')?$info['bus_person']:''); ?></td>
                                <td data-title="业务部门" class="numeric"><?php echo (isset($info['bus_dep']) && ($info['bus_dep'] !== '')?$info['bus_dep']:''); ?></td>
                                <td data-title="服务人员" class="numeric"><?php echo (isset($info['service_person']) && ($info['service_person'] !== '')?$info['service_person']:''); ?></td>
                                <td data-title="服务部门" class="numeric"><?php echo (isset($info['service_dep']) && ($info['service_dep'] !== '')?$info['service_dep']:''); ?></td>
                                <td data-title="评价时间" class="numeric"><?php echo (isset($info['eva_time']) && ($info['eva_time'] !== '')?$info['eva_time']:''); ?></td>
