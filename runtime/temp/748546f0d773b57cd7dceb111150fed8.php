					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="<?php echo url('kefushic/index'); ?>">客户资料</a>
								<i class="icon-angle-right"></i>
							</li>
							...
							<div class="portlet-body form">
								<form action="<?php echo url('update'); ?>" method='post' id="form_sample_2" class="form-horizontal">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="address" data-required="1" class="span6 m-wrap" placeholder="请输入区域" value="<?php echo (isset($info['address']) && ($info['address'] !== '')?$info['address']:''); ?>">
										</div>
									</div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
											<textarea type="text" style="height: 150px;" name="beizhu" data-required="1" class="span6 m-wrap" placeholder="请输入备注" value="<?php echo (isset($info['beizhu']) && ($info['beizhu'] !== '')?$info['beizhu']:''); ?>"><?php echo (isset($info['beizhu']) && ($info['beizhu'] !== '')?$info['beizhu']:''); ?></textarea>
                                        </div>
                                    </div>
									<div class="control-group">
										<label class="control-label">是否置顶<span class="required">*</span></label>
										<div class="controls">
											<select name="top_data" id="">
