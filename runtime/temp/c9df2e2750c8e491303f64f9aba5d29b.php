					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="<?php echo url('branch/index'); ?>">部门管理</a> 
								<i class="icon-angle-right"></i>
							</li>
					...
					<div class="span12">
						<div class="portlet box green">
							...
							<div class="portlet-body form">
								<form action="<?php echo url('role_node'); ?>" method='post' id="form_sample_2" class="form-horizontal">
									...
									<div class="control-group" style='border:1px solid  #000'>
										<div class='span11' >
											<div class='span2'><h4 style='font-weight:bold'>权限配置</h4></div>
										</div>
										<?php echo new_getfkarr('id,menuname,icon','cms_role_name',$nav_menu,['pid'=>0]); foreach($nav_menu as $k=>$v): ?>
										<div class='span11' style='margin-left:20px;'>
											<div class="controls" >
												<div class='span11' style='margin-left:0px;margin-top:10px;'>
												<span>父栏目：</span>
												<input type="checkbox" value="<?php echo $v['id']; ?>" name='node[]' <?php if(in_array($v['id'],$arr)): ?>checked<?php endif; ?>/><span><?php echo $v['menuname']; ?></span><br />
												<span>子栏目：</span>
												<?php echo new_getfkarr('id,menuname,modelname','cms_role_name',$nav_menu2,['pid'=>$v['id']]); foreach($nav_menu2 as $k2=>$v2): ?>
												<input type="checkbox" value="<?php echo $v2['id']; ?>" name='node[]' <?php if(in_array($v2['id'],$arr)): ?>checked<?php endif; ?>/><span><?php echo $v2['menuname']; ?></span>
												<?php endforeach; ?>
												</div>
												<br /><br /><br /><br />
											</div>
